package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_10:String = "client.init.swf.error";
      
      public static const const_17:String = "client.init.swf.loaded";
      ...
      {
         trackLoginStep(const_10);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + this.var_9,const_7,null);
      }
