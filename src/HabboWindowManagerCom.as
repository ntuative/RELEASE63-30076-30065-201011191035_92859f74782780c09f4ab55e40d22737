package
{
   ...
   public class HabboWindowManagerCom extends SimpleApplication
   {
      ...
      public static var text_style_regular_css:Class = HabboWindowManagerCom_text_style_regular_css;
      
      public static var text_style_italic_css:Class = HabboWindowManagerCom_text_style_italic_css;
      
      public static var text_style_bold_css:Class = HabboWindowManagerCom_text_style_bold_css;
      
      public static var text_style_bold_italic_css:Class = HabboWindowManagerCom_text_style_bold_italic_css;
