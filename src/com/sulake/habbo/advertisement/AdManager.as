package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_985:BitmapData = null;
      
      private var var_983:BitmapData = null;
      ...
      {
         this.var_276 = param2 as IHabboCommunicationManager;
         if(this.var_276 == null)
         {
            return;
         }
         this._connection = this.var_276.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2127 = this._config.getKey("interstitial.enabled","false") == "HabboWindowManagerCom_habbo_window_alert_xml";
         this.var_2129 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2126 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1534 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_194 != null && this.var_194.running)
         {
            this.var_194.reset();
            return false;
         }
         ...
         if(this.var_1534 > 0 && this.var_1536 >= this.var_1534)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_984;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1227 = _loc2_.imageUrl;
         this.var_2128 = _loc2_.clickUrl;
         this.var_984 = getTimer();
         if(this.var_1227 != "")
         {
            _loc3_ = this.var_1227;
            ...
            {
               this.var_194 = new Timer(this.var_2126,1);
               this.var_194.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_194.running)
            {
               this.var_194.reset();
            }
            this.var_194.start();
            _loc4_ = new URLRequest(this.var_1227);
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_44,this.interstitialLoaderEventHandler);
         }
         else
         {
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_522,0,0,param1.bitmapData,this.var_2128));
            this.var_984 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_517));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1226 = _loc2_.imageUrl;
         this.var_1535 = _loc2_.clickUrl;
         if(this.var_1226 != "" && this.var_1535 != "")
         {
            _loc3_ = this.var_1226;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1226);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_489,0,0,_loc4_,this.var_1535,this.var_985,this.var_983));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_985 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_983 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
