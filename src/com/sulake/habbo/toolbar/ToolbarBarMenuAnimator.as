package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_186:Boolean = true;
      
      private static const const_1171:Number = 25;
      
      private static const const_1202:Number = 90;
      
      private static const const_826:int = 50;
      ...
      private var var_1256:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_554 = new Object();
         this.var_553 = new Array();
         this.var_555 = new Array();
         super();
         this._windowManager = param1;
         this.var_1256 = param2;
         this.var_667 = new Timer(const_1171);
         this.var_667.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_308[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_826 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_826 || param1.desktop.height - param1.y < const_1170;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1256.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_308.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1256.getIconLoc(param1.iconId);
      ...
      {
         return this.var_553[this.var_555.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_555[this.var_553.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_555.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_555.splice(_loc3_,1);
            this.var_553.splice(_loc3_,1);
         }
         this.var_553.push(param1.name);
         this.var_555.push(param2);
         param1.addEventListener(WindowEvent.const_312,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_223,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_554[_loc3_] == null)
            {
               this.var_554[_loc3_] = new Array();
            }
            if(this.var_554[_loc3_].indexOf(param1) < 0)
            {
               this.var_554[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_308.indexOf(param1) > -1)
         {
            if(const_186)
            {
            ...
            else
            {
               ...
               this.var_308.splice(this.var_308.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_553[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_555[_loc2_];
               if(this.var_554[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_554[_loc3_].length)
                  {
                     this.repositionWindow(this.var_554[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_308.length)
         {
            _loc2_ = this._itemList[this.var_308[_loc7_]];
            if(_loc2_.active)
            {
