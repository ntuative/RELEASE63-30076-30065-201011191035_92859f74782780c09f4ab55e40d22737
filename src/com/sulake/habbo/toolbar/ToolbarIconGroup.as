package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_541:ToolbarBarMenuAnimator;
      ...
      {
         return this.var_1231.indexOf(param1) > -1;
      }
            ...
            if(_loc2_ != null)
            {
               if(!this.containsIcon(_loc2_))
               {
                  ...
                  if(_loc5_.length() > 0)
                  {
                     ...
                     {
                        _loc3_ = "null";
                        this.var_1231.push(_loc3_);
                        _loc6_.dockMenu(_loc3_,this.getMenuYieldList(_loc3_),_loc5_[_loc9_].@locktoicon == "HabboWindowManagerCom_habbo_window_alert_xml");
                        _loc9_++;
                     }
                  }
                  else
                  {
                     this.var_1231.push(_loc2_);
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2164.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_650.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_650.indexOf(param1) > -1;
      }
      ...
      public function get size() : Number
      {
         var _loc1_:* = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_260.length)
         {
            if(this.var_260[_loc2_].exists)
            {
               _loc1_ += this.var_1233;
            }
            _loc2_++;
         }
         return _loc1_;
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1232.length)
         {
            _loc2_ = this.var_650.indexOf(this.var_1232[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_260[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_993 + _loc3_);
                  _loc3_ += this.var_1233;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_260[this.var_650.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_541);
         this.var_35.addChild(_loc2_.window);
         this.var_650.push(param1);
         this.var_260.push(_loc2_);
         return _loc2_;
      }
   }
}
