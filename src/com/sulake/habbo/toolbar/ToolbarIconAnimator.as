package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         this.var_838 = new Array();
         this._state = param1.id;
         this.var_1647 = param1.nextState;
         this.var_1292 = param1.loop;
         if(param1.background != null)
         {
            this.var_835 = this.getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         if(param6 != null)
         {
            this.var_838[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1292 == true || this.var_837 == 0)
         {
      ...
      {
         return this.var_1292 == false && this.var_837 == 1 && this.var_1647 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_838.length)
         {
            _loc2_ = this.var_838[this._frame];
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_835.width),Math.max(param2.height,this.var_835.height));
            _loc3_.copyPixels(this.var_835,this.var_835.rect,new Point(0,0));
