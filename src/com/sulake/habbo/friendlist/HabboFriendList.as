package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_116:IHabboMessenger;
      
      private var var_152:IHabboConfigurationManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1019:IAvatarRenderManager;
      
      private var var_689:ISessionDataManager;
      
      private var var_2338:FriendListLookAndFeel;
      
      private var var_385:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1676:OpenedToWebPopup;
      
      private var var_2331:int;
      
      var var_89:FriendCategories;
      
      private var var_317:FriendRequests;
      
      private var var_1675:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_799:IHabboNotifications;
      
      private var var_575:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2338 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_89 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1675 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_575.stop();
            this.var_575.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_575 = null;
         }
         ...
         if(this.var_116)
         {
            this.var_116.release(new IIDHabboMessenger());
            this.var_116 = null;
         }
         if(this.var_152)
         {
         ...
         if(this.var_1019)
         {
            this.var_1019.release(new IIDAvatarRenderManager());
            this.var_1019 = null;
         }
         if(this.var_799)
         {
            this.var_799.release(new IIDHabboNotifications());
            this.var_799 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_689)
         {
            this.var_689.release(new IIDSessionDataManager());
            this.var_689 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1676 = new OpenedToWebPopup(this);
         }
         this.var_1676.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_89.findFriend(param1);
      }
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = this.tabs.findTab(FriendListTab.const_89);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_317.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_279,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1019.createAvatarImage(param1,AvatarScaleType.const_82,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_152.getKey("client.minimail.embed.enabled");
         return _loc1_ == "HabboWindowManagerCom_habbo_window_alert_xml";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_152.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_116 = param2 as IHabboMessenger;
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1019 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_799 = param2 as IHabboNotifications;
      ...
      {
         this.var_689 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_317 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_89.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_89.addCategory(new FriendCategory(FriendCategory.const_1052,this.getText("friendlist.friends")));
         this.var_89.addCategory(new FriendCategory(FriendCategory.const_339,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_89.addFriend(new Friend(_loc4_));
         }
         this.var_385 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_575)
         {
            this.var_575 = new Timer(120000);
            this.var_575.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_575.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.FRIENDLIST));
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_39,this.onHabboToolbarEvent);
         if(this.var_89.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_89.findCategory(FriendCategory.const_339);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_385.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_375));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_317.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_317.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_385.findTab(FriendListTab.const_93).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_317.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_385.findTab(FriendListTab.const_93);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1675.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_89.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_89.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_385.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_689 || !this.var_317)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_689.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_317.vipLimit;
         }
         else if(this.var_689.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_317.clubLimit;
         }
         if(_loc2_ > this.var_317.limit)
         {
            this.var_317.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Dictionary = this.var_89.getAllFriends();
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_153) as IBitmapWrapperWindow;
