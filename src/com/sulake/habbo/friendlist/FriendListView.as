package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1500:String = "noconvinfo";
      
      private static const const_1501:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1193:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1193 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.FRIENDLIST,this.var_16));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_772 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_237 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1193.prepare(this.var_772);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_959,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_950,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_565,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_600,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_565,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_600,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1192 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1192.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1467 == -1 ? 0 : int(this.var_16.height - this.var_1467);
         var _loc4_:int = this.var_1468 == -1 ? 0 : int(this.var_16.width - this.var_1468);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_237.y = Util.getLowestPoint(this.var_16.content);
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_943,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_565,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_959,false);
         ...
         this.var_1467 = this.var_16.height;
         this.var_1468 = this.var_16.width;
