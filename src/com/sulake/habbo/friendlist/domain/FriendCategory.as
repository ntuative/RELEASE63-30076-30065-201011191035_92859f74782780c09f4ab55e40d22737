package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_341:int = 100;
      ...
      {
         var _loc4_:* = null;
         if(this.var_198.indexOf(param1) >= 0)
         {
            return;
         }
         var _loc2_:String = param1.name.toLowerCase();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_198.length)
         {
            _loc4_ = this.var_198[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_198.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in this.var_198)
         {
            if(_loc2_.selected)
            {
               param1.push(_loc2_);
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean = false) : int
      {
         var _loc4_:* = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this.var_198)
         {
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_198,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         return Math.ceil(this.var_198.length / const_341);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_817 * const_341;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_817 + 1) * const_341,this.var_198.length);
      }
