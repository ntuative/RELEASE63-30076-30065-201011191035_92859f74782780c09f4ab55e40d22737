package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1020:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1020 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1020.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_216 && this._connection != null)
         {
            this._state = RoomSessionEvent.const_84;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1255));
         this.var_1254.add(this.var_1255,getTimer());
         ++this.var_1255;
      }
      
      public function receivedChatWithTrackingId(param1:int) : void
      {
         var _loc2_:Object = this.var_1254.remove(param1);
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_1020 as IUserDataManager;
      }
