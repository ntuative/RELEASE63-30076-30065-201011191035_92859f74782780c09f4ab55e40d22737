package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2618:IWindowContainer;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         if(this._toolbar != null && this.var_1111)
         {
         ...
         this._controller.inventoryViewOpened(this.var_715);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != this.var_714 || !this._controller.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
            if(this._toolbar != null && this.var_1111)
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_715);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_1783);
         _loc2_.invalidate();
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(this._toolbar != null)
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_794,HabboToolbarIconEnum.INVENTORY,this.var_16 as IWindowContainer));
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_714 == InventoryCategory.const_152)
            {
               this.toggleCategoryView(InventoryCategory.const_152);
            }
            else if(this.var_714 == InventoryCategory.const_80)
            {
