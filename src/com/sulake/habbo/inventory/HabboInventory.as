package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_997:IRoomSession;
      ...
      private const const_1784:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_19 != null)
         {
            this.var_19.events.removeEventListener(RoomSessionEvent.const_84,this.roomSessionEventHandler);
            this.var_19.events.removeEventListener(RoomSessionEvent.const_90,this.roomSessionEventHandler);
            this.var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_501,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_53.getValue(InventoryCategory.const_80));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_53.getValue(InventorySubCategory.const_262));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_53.getValue(InventoryCategory.const_756));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_53.getValue(InventoryCategory.const_256));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_53.getValue(InventoryCategory.const_357));
      }
      ...
      {
         return PetsModel(this.var_53.getValue(InventoryCategory.const_152));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_53.getValue(InventoryCategory.const_358) as MarketplaceModel;
      }
      ...
      {
         return this.var_102.clubDays;
      }
      
      public function get clubPeriods() : int
      {
         return this.var_102.clubPeriods;
      }
      
      public function get clubPastPeriods() : int
      {
         return this.var_102.clubPastPeriods;
      }
      
      public function get clubHasEverBeenMember() : Boolean
      {
         return this.var_102.clubHasEverBeenMember;
      }
      ...
      {
         this.var_102.clubPeriods = param1;
         this.var_102.clubDays = param2;
         this.var_102.clubHasEverBeenMember = param3;
         this.var_102.isVIP = param4;
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_19.events.addEventListener(RoomSessionEvent.const_84,this.roomSessionEventHandler);
         this.var_19.events.addEventListener(RoomSessionEvent.const_90,this.roomSessionEventHandler);
         this.var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_501,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_90:
               this.var_997 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_501:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_394 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_19 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_53.add(InventoryCategory.const_358,_loc1_);
         ...
         this.var_53.add(InventoryCategory.const_756,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_394);
         this.var_53.add(InventoryCategory.const_357,_loc5_);
         ...
         this.var_53.add(InventorySubCategory.const_262,_loc6_);
         ...
         this.var_53.add(InventoryCategory.const_152,_loc8_);
         this.var_171 = true;
         if(this.var_2241)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_262:
               this._view.toggleCategoryView(InventoryCategory.const_80,false);
         }
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1784);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_873));
      }
