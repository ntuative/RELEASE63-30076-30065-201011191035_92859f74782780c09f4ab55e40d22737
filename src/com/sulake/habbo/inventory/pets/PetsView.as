package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         this.var_443 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_311);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_568.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_443.removeGridItem(_loc2_.window);
         if(this.var_311 == _loc2_)
         {
            this.var_311 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_568 == null || this.var_568.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_568.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_568.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_443.addGridItem(_loc2_.window);
            this.var_568.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_311.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_62)
         {
            ...
            {
               case "tab_floor":
                  this.var_62.switchCategory(FurniModel.const_42);
                  break;
               case "tab_wall":
                  this.var_62.switchCategory(FurniModel.const_47);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_311 != null)
         {
            this.var_311.setSelected(false);
         }
         this.var_311 = param1;
         if(this.var_311 != null)
         {
            this.var_311.setSelected(true);
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         {
            _loc12_ = param1.pet;
            _loc13_ = this._avatarRenderer.createPetImageFromFigure(_loc12_.figure,AvatarScaleType.const_50,this);
            if(_loc13_ == null)
            {
               return;
            }
