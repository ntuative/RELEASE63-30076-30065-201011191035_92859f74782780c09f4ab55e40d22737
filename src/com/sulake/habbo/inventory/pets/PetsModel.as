package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(this.var_1087.add(param1.id,param1))
         {
      ...
      {
         if(param1 == InventoryCategory.const_152 && this._controller.isVisible)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1730 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_34,RoomObjectTypeEnum.const_251,_loc3_.figure);
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in this.var_1087)
         {
            if(_loc2_.id == param1)
            {
               return _loc2_;
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1730 && param1.type == RoomEngineObjectEvent.const_228)
         {
