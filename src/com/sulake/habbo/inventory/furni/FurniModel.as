package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_47:String = "wall";
      
      public static const const_364:String = "pets";
      
      private static const const_1106:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_228,this.onObjectPlaced);
         this._catalog = param7;
         this.var_512 = new Timer(const_1106,1);
         this.var_512.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_1926 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_228,this.onObjectPlaced);
               }
            ...
            {
               this.var_512.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_512.stop();
               this.var_512 = null;
            }
            if(this.var_174 != null)
            {
               this.var_174.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_174.stop();
               this.var_174 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_373)
         {
         ...
         else if(param3 == FurniCategory.const_356)
         {
         ...
         if(this.var_755 == null)
         {
            this.var_755 = this._windowManager.buildFromXML(this.var_1926) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_755.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_42,const_47];
         var _loc5_:int = 0;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_174 = new Timer(param1,1);
            this.var_174.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_174.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_80 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_47:
                  ...
                  break;
               case const_364:
                  this._controller.toggleInventoryPage(InventoryCategory.const_152);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_358);
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_42,const_47];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_42,const_47];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_407.add(const_42,new Array());
         this.var_407.add(const_47,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_262;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_356 || _loc3_.category == FurniCategory.const_373 || _loc3_.category == FurniCategory.const_317)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1174 && param1.type == RoomEngineObjectEvent.const_228)
         {
            this.var_1174 = false;
         }
      }
      ...
      {
         return this.var_407.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_262:
               ...
               break;
            case InventorySubCategory.const_974:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_407.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_407.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_728)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
