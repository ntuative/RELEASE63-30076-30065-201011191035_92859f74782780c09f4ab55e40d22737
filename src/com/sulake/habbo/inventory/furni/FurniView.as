package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1805:int = 0;
      
      private const const_869:int = 1;
      
      private const const_1521:int = 2;
      
      private const const_1520:int = 3;
      
      private const const_1527:int = 42;
      
      private const const_1526:int = 120;
      ...
      private var var_711:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_466.add(FurniModel.const_42,new FurniGridView(this.var_62,FurniModel.const_42,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_466.add(FurniModel.const_47,new FurniGridView(this.var_62,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_466.getValue(this.var_367);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_367);
         if(!this.var_62.isListInited())
         {
            _loc2_ = this.const_869;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1521;
         }
         else
         {
            _loc2_ = this.const_1520;
         }
         if(this.var_2291 == _loc2_)
         {
            return;
         }
         this.var_2291 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_869:
               ...
               break;
            case this.const_1521:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1520:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_42,FurniModel.const_47];
         var _loc4_:int = 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_367);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_373)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_356)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_711 && this.var_711.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1526)
         {
            _loc3_ = this.const_1526;
         }
         else if(_loc3_ < this.const_1527)
         {
            _loc3_ = this.const_1527;
         }
         else
         {
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_62)
         {
            switch(param2.name)
            {
               case "tab_floor":
