package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1297:uint = 9;
      
      public static const const_163:uint = 0;
      
      public static const const_172:uint = 1;
      
      public static const const_352:uint = 2;
      
      public static const const_274:uint = 3;
      
      public static const const_421:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_48.updateItemList(this.var_663);
         this.var_48.updateItemList(this.var_1253);
      ...
      public function close() : void
      {
         if(this.var_624)
         {
            if(this._state != const_163 && this._state != const_252)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_163;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_974);
            this.var_624 = false;
         }
      ...
      {
         this.var_48.setMinimized(param1 != InventoryCategory.const_80);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_664 + " OTHER: " + this.var_1015);
         ...
         {
            case const_163:
               if(param1 == const_172 || param1 == const_252)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_48.alertPopup(TradingView.const_1089);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_663)
            {
               this.var_664 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_663)
            {
               this.var_48.alertPopup(TradingView.const_1044);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_266.length < const_1297)
         {
