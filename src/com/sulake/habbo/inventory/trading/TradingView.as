package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_819:uint = 4284532064;
      
      private static const const_820:uint = 2577770;
      
      public static const const_909:int = 0;
      
      public static const const_1044:int = 1;
      ...
      private var var_357:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_357 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1549 = this.createMinimizedWindow();
         }
         if(!this.var_2163)
         {
            return this.var_64;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_819) : uint(const_820);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_819) : uint(const_820);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1037)
            {
            ...
            this.var_357.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_477);
            this.var_357.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_357.hideDelayed();
         }
      }
