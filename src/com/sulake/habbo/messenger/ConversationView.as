package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1195:int = 10;
      
      private static const const_849:int = 100;
      
      private static const const_1194:int = 20;
       
      
      private var var_116:HabboMessenger;
      
      private var var_2391:IScrollbarWindow;
      
      private var var_1706:IContainerButtonWindow;
      
      private var var_52:IItemListWindow;
      
      private var var_471:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_116 = param1;
         this.var_1706 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_52 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2391 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_116.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_849 + const_1194)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_116.getButtonImage(param1);
      ...
      private function refreshListDims() : void
      {
         ...
         this.var_52.autoArrangeItems = false;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_52.numListItems)
         {
            _loc2_ = ITextWindow(this.var_52.getListItemAt(_loc1_));
      ...
      {
         param1.width = this.var_52.width;
         param1.height = param1.textHeight + const_1195;
         param1.invalidate();
      }
      ...
      private function findAddIndex() : int
      {
         ...
         while(_loc1_ < this.var_52.numListItems)
         {
            _loc2_ = this.var_52.getListItemAt(_loc1_);
            if(!_loc2_.visible)
            {
               return _loc1_;
            }
      ...
      {
         var _loc1_:Conversation = this.var_116.conversations.findSelectedConversation();
         if(_loc1_ == null)
         {
            return;
         }
         if(this.var_471 == null || _loc1_.id != this.var_471.id)
         {
            this.var_471 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_471.followingAllowed)
         {
            this.var_1706.enable();
         }
         else
         {
            this.var_1706.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_52.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_471.messages.length - const_849);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_471.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_471.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      {
         var _loc4_:ITextWindow = this.var_52.getListItemAt(param2) as ITextWindow;
         if(_loc4_ == null)
         {
            if(!param1)
            {
            ...
            _loc4_ = ITextWindow(this.var_116.getXmlWindow("msg_entry"));
            _loc4_.width = this.var_52.width;
            this.var_52.addListItem(_loc4_);
         }
         if(!param1)
         {
            _loc4_.height = 0;
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_694 || param3.type == Message.const_561 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_471.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_116.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_116.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_116.send(new FollowFriendMessageComposer(this.var_471.id));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_116.conversations.closeConversation();
         this.var_116.messengerView.refresh();
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_754)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1073)
         {
            return 4288269465;
         }
         return 4291611852;
