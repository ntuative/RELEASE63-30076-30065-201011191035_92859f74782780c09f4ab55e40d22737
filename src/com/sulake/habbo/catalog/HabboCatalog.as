package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_318:ICatalogNavigator;
      
      private var var_102:Purse;
      ...
      private var var_2366:GiftWrappingConfiguration;
      
      private var var_1063:ClubGiftController;
      
      private var var_467:ClubBuyController;
      
      public function HabboCatalog(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_102 = new Purse();
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_102.credits)
         {
            this.showNotEnoughCreditsAlert("${catalog.alert.notenough.credits.description}");
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_102.getActivityPointsForType(param1.activityPointType))
         {
         ...
         {
            this.var_467.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_318.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_102.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_102.getActivityPointsForType(Purse.const_465)));
         var _loc1_:int = 0;
         if(!this.var_102.hasClubLeft)
         {
            _loc2_ = "catalog.purse.club.join";
         }
         else
         {
            if(this.var_102.isVIP)
            {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_102.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_102.clubPeriods));
         }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_858)
         {
            if(!this.var_394.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_318 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_242,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_84:
               this.var_1687 = param1.session.isPrivateRoom;
               if(this.var_85 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1063 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_467 == null)
         {
            this.var_467 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_318.buildCatalogIndex(_loc2_);
         if(this.var_691 && this.var_691 != "")
         {
            this.var_318.openPage(this.var_691);
            this.var_691 = "";
            this.var_857 = -1;
         }
         else if(this.var_857 > -1)
         {
            this.var_318.openPageById(this.var_857,this.var_1688);
            this.var_857 = -1;
            this.var_1688 = -1;
            this.var_691 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_102.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2367 && this.var_577 != null)
         {
            this.var_577.playSound(HabboSoundTypesEnum.const_880);
         }
         this.var_2367 = false;
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_102.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2365 && this.var_577 != null)
         {
            this.var_577.playSound(HabboSoundTypesEnum.const_1056);
         }
         this.var_2365 = false;
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_102.activityPoints = _loc2_.points;
         this.updatePurse();
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_102.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_102.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_102.isVIP = _loc2_.isVIP;
         this.var_102.pastClubDays = _loc2_.pastClubDays;
         this.var_102.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1063.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2366 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "HabboWindowManagerCom_habbo_window_alert_xml" == this.var_152.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_152.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_184)
         {
            _loc3_ = this.var_152.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
