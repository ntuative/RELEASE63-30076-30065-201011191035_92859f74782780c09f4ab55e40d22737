package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2640:String = "magic.credits";
      
      private var var_2597:String = "magic.pixels";
      
      private var var_2596:String = "catalog.page.club";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         this.var_296 = [];
         this.var_52 = this._container.findChildByName("navigationList") as IItemListWindow;
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in this._index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(this.var_52);
            }
         }
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_296.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_296)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_296.indexOf(_loc6_);
            this.var_296.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(this.var_296.indexOf(param1) == -1)
         {
      ...
      private function openNavigatorAtNode(param1:ICatalogNode) : void
      {
         ...
         for each(_loc2_ in this.var_296)
         {
            _loc2_.deActivate();
            _loc2_.close();
         }
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = this._catalog.configuration.getKey("client.credits.embed.enabled","false") == "HabboWindowManagerCom_habbo_window_alert_xml";
         if(false && _loc1_)
         {
      ...
      {
         this.openPage(this.var_2597);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2596,true);
      }
