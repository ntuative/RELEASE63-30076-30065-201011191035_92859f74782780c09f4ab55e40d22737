package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_539)
            {
               this.var_539 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_539).toString().length - 1);
         this.var_539 = Math.ceil(this.var_539 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_539.toString();
         _loc3_.draw(_loc6_);
         this.var_996 = param1 - _loc6_.textWidth - 2;
         this.var_800 = param2 - _loc6_.textHeight;
         ...
         _loc9_.graphics.lineTo(0,this.var_800);
         _loc10_ = 0;
         while(_loc10_ <= 5)
         {
            _loc4_ = (this.var_800 - 1) / 5 * _loc10_;
            _loc9_.graphics.moveTo(0,_loc4_);
            _loc9_.graphics.lineTo(this.var_996 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_996,(param2 - this.var_800) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_996 + this.var_996 / -this.var_2599 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_800 - this.var_800 / this.var_539 * this.var_155[param1];
      }
