package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public static const const_164:int = 5;
      
      private static const const_846:int = 0;
      
      private static const const_384:int = 1;
      
      private static const const_847:int = 2;
      ...
      {
         return this.var_580 != const_846;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1699 != RecyclerStatusMessageEvent.const_975;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_580 == const_384;
      }
      ...
      {
         this.var_580 = const_847;
         this.var_104 = new Array(const_164);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_164)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_580 = const_846;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1699)
         {
            case RecyclerStatusMessageEvent.const_1419:
               this.var_580 = const_384;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_975:
               if(this._view == null)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1480:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_898:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1408:
      ...
      public function getSlotContent(param1:int) : FurniSlotItem
      {
         ...
         if(param1 >= this.var_104.length)
         {
            return null;
         }
         return this.var_104[param1];
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_104.length > 0)
         {
            oldObjectData = this.var_104[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_164)
            {
               oldObjectData = this.var_104[newSlotId];
         ...
         this.var_104[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_104[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_104[param1].id))
         {
            return;
         }
         this.var_104[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_104.length)
         {
            _loc3_ = this.var_104[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_104.length < const_164)
         {
            return false;
         }
         var _loc1_:int = 0;
         while(_loc1_ < this.var_104.length)
         {
            if(this.var_104[_loc1_] == null)
            {
               return false;
            }
            _loc1_++;
