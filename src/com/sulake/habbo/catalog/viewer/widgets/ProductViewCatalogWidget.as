package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1485:BitmapData;
      
      private var var_771:ITextWindow;
      ...
      private var var_1203:IScrollbarWindow;
      ...
      {
         this.var_771 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_957 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_80 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1486 = new Point(this.var_80.x,this.var_80.y);
         this.var_418 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1203 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1485 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_418 != null)
         {
            this.var_418.visible = false;
            this.var_418.destroyGridItems();
         }
         if(this.var_1203 != null)
         {
            this.var_1203.visible = false;
         }
         ...
         this.var_771.text = _loc4_;
         this.var_957.text = _loc5_;
         this.var_771.height = this.var_771.textHeight + 5;
         this.var_957.y = this.var_771.y + this.var_771.height;
         this.var_957.height = Math.max(130,this.var_957.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_508:
                  _loc6_ = this.var_1485.clone();
                  if(this.var_418 != null)
                  {
                     this.var_418.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_418,this.var_1203,this.var_1420);
                     this.var_418.scrollV = 0;
                  }
                  break;
               ...
               case Offer.const_531:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_241:
                        ...
                        _loc6_ = new BitmapData(this.var_80.width,this.var_80.height,false,_loc13_);
                        _loc14_ = null;
                        _loc15_ = page.viewer.catalog as HabboCatalog;
                        if(_loc15_.avatarRenderManager != null)
                        {
                           _loc17_ = _loc15_.sessionDataManager.figure;
                           _loc16_ = _loc15_.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_50);
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_43,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_299,AvatarAction.const_463);
                              _loc16_.appendAction(AvatarAction.const_285,_loc8_.productClassId);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_80);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2027)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2027 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_80 != null && true)
         {
            ...
            if(this.var_80.bitmap == null)
            {
               this.var_80.bitmap = new BitmapData(this.var_80.width,this.var_80.height,true,16777215);
            }
            this.var_80.bitmap.fillRect(this.var_80.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_80.width - param1.width) / 2,(this.var_80.height - param1.height) / 2);
            this.var_80.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_80.invalidate();
            this.var_80.x = this.var_1486.x;
            this.var_80.y = this.var_1486.y;
            if(param3 != null)
            {
               this.var_80.x += param3.x;
               this.var_80.y += param3.y;
            }
         }
         if(param2)
         {
