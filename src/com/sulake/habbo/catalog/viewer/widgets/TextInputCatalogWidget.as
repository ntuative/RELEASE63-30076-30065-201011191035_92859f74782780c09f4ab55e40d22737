package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         this.var_944 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_944 != null)
         {
            this.var_944.addEventListener(WindowKeyboardEvent.const_695,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_944.text));
      }
   }
}
