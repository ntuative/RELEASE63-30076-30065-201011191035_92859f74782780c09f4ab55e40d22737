package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1126:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1126.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_1125 != null)
         {
            this.var_1125.removeEventListener(WindowKeyboardEvent.const_156,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_1126 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1126 != null)
         {
            this.var_1126.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1125 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1125 != null)
         {
            this.var_1125.addEventListener(WindowKeyboardEvent.const_156,this.windowKeyEventProcessor);
         }
      }
