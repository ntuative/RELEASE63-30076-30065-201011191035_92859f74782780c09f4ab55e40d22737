package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1516:int = 1;
      
      private const const_1515:int = 2;
      
      private const const_1783:int = 40;
      
      private const const_1782:int = 10;
      
      private var var_668:Array;
      
      private var var_1259:MarketPlaceOfferData;
      
      private var _itemList:IItemListWindow;
      
      private var var_556:IWindowContainer;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_442)
         {
            this.var_442.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_442 = null;
         }
      }
      ...
      public function updateStats() : void
      {
         ...
         switch(_loc5_.name)
         {
            case "price_development":
               _loc6_ = new MarketplaceChart(_loc1_.dayOffsets,_loc1_.method_1);
               break;
            case "trade_volume":
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_668 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_668 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_668));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_556)
         {
            ...
            this.var_556 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_556)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1515,_loc2_.length);
         if(!this.var_442)
         {
            this.var_442 = new Timer(25);
            this.var_442.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1025 = 0;
         this.populateList();
         this.var_442.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1025 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1025));
            ++this.var_1025;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_556 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_556.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1516);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_668.length)
         {
            _loc4_ = this.var_668[_loc6_.selection];
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_108)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1782;
                  break;
               case "search_input":
                  _loc8_ = this.const_1783;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1259.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_62)
