package com.sulake.habbo.room.messages
{
   ...
   public class RoomObjectRoomMaskUpdateMessage extends RoomObjectUpdateMessage
   {
      ...
      public static const const_616:String = "RORMUM_ADD_MASK";
      
      public static const const_1254:String = "door";
      
      public static const const_488:String = "window";
      ...
      private var var_2160:Vector3d = null;
      
      private var var_2158:String = "window";
      ...
      public function RoomObjectRoomMaskUpdateMessage(param1:String, param2:String, param3:String = null, param4:IVector3d = null, param5:String = "window")
      {
         ...
         if(param4 != null)
         {
            this.var_2160 = new Vector3d(param4.x,param4.y,param4.z);
         }
         this.var_2158 = param5;
      }
