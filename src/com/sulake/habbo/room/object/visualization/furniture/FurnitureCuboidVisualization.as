   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_113 != null)
         {
            ...
            {
               _loc2_ = this.var_113[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_374);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_586);
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         this.method_11(param1,param2);
      }
      
      protected function method_11(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < this.var_113.length)
         {
            ...
            _loc9_ = this.var_113[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_1579;
               }
