package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      public function FurniturePlanetSystemVisualization()
      {
         ...
         this.var_2053 = new Vector3d(0,0,0);
         super();
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         if(this.var_221 == null && spriteCount > 0)
         {
            if(!this.method_7())
            {
               return null;
         ...
         if(this.var_221 != null)
         {
            ...
            {
               _loc2_ = this.var_221[_loc3_];
               _loc2_.update(this._offsetArray,this.var_2053,param1);
               _loc3_++;
            }
      ...
      private function method_7() : Boolean
      {
         var _loc7_:* = null;
         var _loc9_:* = null;
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1013);
