package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1353:int = const_332;
      ...
      public static const const_303:int = const_103;
      ...
      private var var_682:Vector3d = null;
      ...
      private var var_2064:Number = -1.0;
      
      private var var_2065:Number = 1.0;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1.0, param5:Number = 1.0, param6:Number = -1.0, param7:Number = 1.0)
      {
         ...
         this.var_2064 = param6;
         this.var_2065 = param7;
         this.var_682 = new Vector3d();
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_682 != null)
         {
            this.var_682.assign(new Vector3d());
         }
         this.var_584 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_321.length)
         {
            _loc2_ = this.var_321[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_321.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_321[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_321[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_29 != null)
            {
               if(this.var_29.width == param2 && this.var_29.height == param3 && Vector3d.isEqual(this.var_682,param4))
               {
                  if(param1 != null)
                  {
                     this.copyCachedBitmapOnCanvas(param1,this.var_584,param6,param7);
                     return param1;
                  }
                  return this.var_29;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_321.length)
         {
            _loc11_ = this.var_321[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1709 == const_103)
         {
            _loc5_ = new Rectangle(0,0,this.var_29.width,this.var_584);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_29.height - this.var_584,this.var_29.width,this.var_584);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_321.length == 1)
         {
            _loc4_ = this.var_321[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
