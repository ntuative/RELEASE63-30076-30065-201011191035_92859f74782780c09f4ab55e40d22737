package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public static const const_700:int = 0;
      ...
      public function render(param1:int, param2:IVector3d) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_29 != null)
            {
               if(this.var_29.height == param1 && Vector3d.isEqual(this.var_682,param2))
               {
                  return this.var_29;
               }
               this.var_29.dispose();
      ...
      {
         if(this.var_31.length == 0 || this.var_29 == null)
         {
            return;
         }
