package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_1693:int = 16777216;
      
      private var var_2615:int = 69069;
      
      private var var_2614:int = 5;
      ...
      {
         var _loc1_:int = this.var_2615 * this.var_1694 + this.var_2614;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1693;
         this.var_1694 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1693 * param2);
      }
   }
}
