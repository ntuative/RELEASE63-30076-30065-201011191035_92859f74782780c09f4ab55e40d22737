package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1452:int = 13421772;
      
      private static const const_837:int = 16777215;
      ...
      public static const const_1405:int = 16777215;
      
      public static const const_1233:int = 13421772;
      
      public static const const_1358:int = 10066329;
      ...
      private var var_679:Rectangle = null;
      
      private var var_459:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_2296:String = null;
      
      private var var_1053:uint = 16777215;
      
      private var var_2297:int = 255;
      
      private var var_2300:int = 255;
      
      private var var_2295:int = 255;
      ...
      private const const_1786:int = 250;
      
      private var var_1559:int = -1;
      
      private var var_1367:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_459 = new RoomPlaneBitmapMaskParser();
         this.var_270["null"] = false;
         this.var_270["null"] = true;
         this.var_270["null"] = true;
         this.var_270["null"] = true;
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_113.length)
            {
               _loc4_ = this.var_113[_loc3_] as RoomPlane;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_679 = super.boundingRectangle;
         }
         return new Rectangle(this.var_679.x,this.var_679.y,this.var_679.width,this.var_679.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_113.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_113[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1070);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_947);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_92,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1410)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_114,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1786 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         if(this.method_11(param1,_loc5_,param2))
         {
            _loc7_ = true;
         }
         if(_loc7_)
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_312.length)
            {
               _loc10_ = this.var_570[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_312[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_92)
               {
                  if(this.var_1657)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2295 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2300 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2297 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1559)
         {
            this.var_1559 = param1.updateId;
            this.var_679 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1367 || _loc3_.y != this.var_2298 || _loc3_.z != this.var_2301 || param1.scale != this.var_2299))
            {
               this.var_1367 = _loc3_.x;
               this.var_2298 = _loc3_.y;
               this.var_2301 = _loc3_.z;
               this.var_2299 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_962);
            if(_loc3_ != this.var_2296)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2296 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_735));
            if(_loc4_ != this.var_1053)
            {
               this.var_1053 = _loc4_;
               this.var_2295 = this.var_1053 & 255;
               this.var_2300 = this.var_1053 >> 8 & 255;
               this.var_2297 = this.var_1053 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1026));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_212 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_718);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_605);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_771);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_799));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_744));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_746));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_113.length)
         {
            _loc5_ = this.var_113[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_92 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
      ...
      {
         if(param1 != this.var_270["null"] || param2 != this.var_270["null"] || param3 != this.var_270["null"])
         {
            this.var_270["null"] = param1;
            this.var_270["null"] = param2;
            this.var_270["null"] = param3;
            this.var_312 = [];
            this.var_570 = [];
         }
      }
      
      protected function method_11(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         var _loc10_:int = 0;
         var _loc11_:* = null;
         var _loc12_:* = null;
         ...
         var _loc6_:Array = this.var_312;
         if(this.var_312.length == 0)
         {
            _loc6_ = this.var_113;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_312.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_270[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_312.push(_loc12_);
                        this.var_570.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1579;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_459.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_113.length)
         {
            _loc3_ = this.var_113[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
               _loc3_.resetBitmapMasks();
               if(_loc3_.type == RoomPlane.const_92)
               {
                  _loc4_.push(_loc7_);
               }
            }
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_459.maskCount)
         {
            _loc10_ = this.var_459.getMaskType(_loc8_);
            _loc11_ = this.var_459.getMaskLocation(_loc8_);
            _loc12_ = this.var_459.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_113.length)
               {
                  _loc3_ = this.var_113[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_114 || _loc3_.type == RoomPlane.const_92)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_114 || _loc3_.type == RoomPlane.const_92 && _loc12_ == RoomPlaneBitmapMaskData.const_212)
                              {
                                 _loc3_.addBitmapMask(_loc10_,_loc16_,_loc17_);
                              }
                              else if(_loc3_.type == RoomPlane.const_92)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_113[_loc18_] as RoomPlane;
