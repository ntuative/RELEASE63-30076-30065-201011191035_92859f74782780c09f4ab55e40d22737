   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_344,_loc4_.dirHead);
            return;
         }
         if(param1 is RoomObjectAvatarChatUpdateMessage)
         {
            ...
            this.var_1274 = getTimer() + _loc5_.numberOfWords * 1000;
            return;
         }
         ...
         if(param1 is RoomObjectAvatarSleepUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_466,Number(_loc8_.isSleeping));
            return;
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_937,Number(getTimer()));
            _loc2_.setNumber(RoomObjectVariableEnum.const_902,Number(_loc10_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            _loc11_ = param1 as RoomObjectAvatarFigureUpdateMessage;
            _loc12_ = _loc2_.getString(RoomObjectVariableEnum.const_175);
            _loc2_.setString(RoomObjectVariableEnum.const_175,_loc11_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1403,_loc11_.race);
            return;
         }
      }
