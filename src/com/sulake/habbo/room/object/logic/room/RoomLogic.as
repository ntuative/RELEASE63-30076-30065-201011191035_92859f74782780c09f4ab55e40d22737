package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1488:int = 255;
      
      private var var_1204:uint = 16777215;
      
      private var var_1489:int = 255;
      
      private var var_961:uint = 16777215;
      
      private var var_1487:int = 255;
      
      private var var_960:int = 0;
      
      private var var_1490:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1070,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_735,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_799,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_744,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_746,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_960)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1488;
            if(_loc2_ - this.var_960 >= this.var_1490)
            {
               _loc3_ = this.var_961;
               _loc4_ = this.var_1487;
               this.var_960 = 0;
            }
            else
            {
               _loc7_ = this.var_1204 >> 16 & 255;
               _loc8_ = this.var_1204 >> 8 & 255;
               _loc9_ = this.var_1204 & 255;
               _loc10_ = this.var_961 >> 16 & 255;
               _loc11_ = this.var_961 >> 8 & 255;
               _loc12_ = this.var_961 & 255;
               _loc13_ = (_loc2_ - this.var_960) / this.var_1490;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1489 + (this.var_1487 - this.var_1489) * _loc13_;
               this._color = _loc3_;
               this.var_1488 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_735,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_651:
               param2.setString(RoomObjectVariableEnum.const_605,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_656:
               param2.setString(RoomObjectVariableEnum.const_718,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_676:
               param2.setString(RoomObjectVariableEnum.const_771,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_474:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_212)
               {
                  _loc5_ = "null";
               }
               this.var_459.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_616:
               _loc4_ = this.var_459.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_459.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_962,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1034:
               param2.setNumber(RoomObjectVariableEnum.const_799,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_958:
               param2.setNumber(RoomObjectVariableEnum.const_744,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_746,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1026,int(param1.bgOnly));
         this.var_1204 = this._color;
         this.var_1489 = this.var_1488;
         this.var_961 = _loc3_;
         this.var_1487 = _loc4_;
         this.var_960 = getTimer();
         this.var_1490 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_493,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1474,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1431,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1374,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_493,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_169)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_151 || _loc13_ == RoomPlaneData.const_290)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
