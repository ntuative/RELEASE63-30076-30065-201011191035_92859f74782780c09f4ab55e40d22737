package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_326,"");
         _loc2_.setString(RoomObjectVariableEnum.const_602,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_485,Number(false));
         this.var_858 = true;
      }
      ...
      {
         super.update(param1);
         if(this.var_1379 > 0 && param1 > this.var_1379)
         {
            this.adDelayTimeout();
            this.var_1379 = 0;
         }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_968:
                  _loc2_.setString(RoomObjectVariableEnum.const_326,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_602,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_485,Number(true));
                  this.var_1379 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_954);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_485,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_457)
               {
