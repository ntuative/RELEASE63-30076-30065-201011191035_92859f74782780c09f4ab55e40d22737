package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_967 = param2 as IAvatarRenderManager;
      }
      ...
      public function createRoomObjectVisualization(param1:String) : IRoomObjectGraphicVisualization
      {
         ...
         switch(param1)
         {
            case RoomObjectVisualizationEnum.const_195:
            ...
            case RoomObjectVisualizationEnum.const_280:
               ...
               break;
            case RoomObjectVisualizationEnum.const_893:
               _loc2_ = PublicRoomPoolVisualization;
               break;
            case RoomObjectVisualizationEnum.const_177:
            ...
            case RoomObjectVisualizationEnum.const_66:
               ...
               break;
            case RoomObjectVisualizationEnum.const_942:
               _loc2_ = FurnitureVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1075:
               _loc2_ = AnimatedFurnitureVisualization;
               break;
            case RoomObjectVisualizationEnum.const_927:
            ...
            case RoomObjectVisualizationEnum.const_264:
               ...
               break;
            case RoomObjectVisualizationEnum.const_1062:
               _loc2_ = FurnitureQueueTileVisualization;
               break;
            case RoomObjectVisualizationEnum.const_923:
               _loc2_ = FurniturePartyBeamerVisualization;
               break;
            case RoomObjectVisualizationEnum.const_1329:
               _loc2_ = FurnitureCuboidVisualization;
               break;
            case RoomObjectVisualizationEnum.const_934:
            ...
            case RoomObjectVisualizationEnum.const_265:
               ...
               break;
            case RoomObjectVisualizationEnum.const_1035:
