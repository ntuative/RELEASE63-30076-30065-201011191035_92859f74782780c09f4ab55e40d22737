package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_768:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_683 = _loc4_.content as BitmapData;
         ...
         this.var_767 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_683.width,this.var_683.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_683,this.var_683.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_948.width,this.var_948.height,true,0);
            _loc5_ = this.var_948.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_768.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_767.width,this.var_767.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_767,this.var_767.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_768)
            {
               switch(this.var_768.clubLevel)
               {
                  case HabboClubLevelEnum.const_51:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_60:
                     _loc4_.style = HabboIconType.const_549;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_55:
                     _loc4_.style = HabboIconType.const_766;
                     _loc4_.visible = true;
               }
            }
            else
