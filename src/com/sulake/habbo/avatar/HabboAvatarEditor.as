package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1139:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      ...
      private var var_977:AvatarEditorHandler;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_89 != null)
         {
            for each(_loc1_ in this.var_89)
            {
               _loc1_.dispose();
               _loc1_ = null;
            }
      ...
      private function init() : void
      {
         ...
         if(!this.var_171)
         {
            ...
            this.var_532["null"] = new FigureData(this);
            this.var_532["null"] = new FigureData(this);
            _loc1_ = this.var_532["null"];
            _loc2_ = this.var_532["null"];
            _loc1_.loadAvatarData(const_1139,FigureData.const_74);
            _loc2_.loadAvatarData(const_1141,FigureData.FEMALE);
            this.var_89 = new Map();
            this.var_425 = new Map();
            this.var_89.add(AvatarEditorFigureCategory.const_753,new BodyModel(this));
            this.var_89.add(AvatarEditorFigureCategory.const_43,new HeadModel(this));
            this.var_89.add(AvatarEditorFigureCategory.const_250,new TorsoModel(this));
            this.var_89.add(AvatarEditorFigureCategory.const_662,new LegsModel(this));
            this.var_89.add(AvatarEditorFigureCategory.const_890,new HotLooksModel(this));
            this.var_425.add(AvatarEditorSideCategory.const_99,new WardrobeModel(this));
            this.var_425.add(AvatarEditorSideCategory.const_480,new ClubPromoModel(this));
            this.var_171 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         this.var_978 = param3;
         var _loc4_:FigureData = this.var_532[param2];
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(this.var_89)
         {
            for each(_loc5_ in this.var_89)
            {
               _loc5_.reset();
            }
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_785.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_785.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this._windowContext == null)
            {
               this._windowContext = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_57,HabboWindowStyle.const_35,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_753);
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = this.var_89.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_426 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_785 = this.var_426.getFigureData(AvatarType.const_104);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_977 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_532[this.var_849];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1219 != null)
         {
            ...
            this.var_1219.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1527;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_978 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1140)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1386.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_426.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_426.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1135.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1428)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_978 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1135.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function hasInvalidClubItems() : Boolean
      {
         ...
         for each(_loc2_ in this.var_89)
         {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_978 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_425.getValue(AvatarEditorSideCategory.const_99);
      }
