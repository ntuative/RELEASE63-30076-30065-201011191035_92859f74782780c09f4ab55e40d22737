package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationLayerData implements IAnimationLayerData
   {
      ...
      public static const const_604:String = "bodypart";
      ...
      public function AnimationLayerData(param1:AvatarStructure, param2:XML, param3:String, param4:int, param5:IActionDefinition)
      {
         ...
         this.var_1889 = parseInt(param2.@frame);
         this._dx = parseInt(param2.@dx);
         this.var_1356 = parseInt(param2.@dy);
         this.var_1355 = parseInt(param2.@dz);
         this.var_1522 = parseInt(param2.@dd);
         this._type = param3;
         this.var_930 = String(param2.@base);
      ...
      private function baseAsInt() : int
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_930.length)
         {
            _loc1_ += this.var_930.charCodeAt(_loc2_);
            _loc2_++;
         }
         return _loc1_;
      }
