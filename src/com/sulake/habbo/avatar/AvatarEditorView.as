package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1135:IWindowContainer;
      
      public static var var_1386:IWindowContainer;
      
      public static var var_1821:int = 6710886;
      ...
      private var var_487:ITabSelectorWindow;
      ...
      private var var_2561:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1134 = [];
         this.var_1340 = [AvatarEditorFigureCategory.const_753,AvatarEditorFigureCategory.const_43,AvatarEditorFigureCategory.const_250,AvatarEditorFigureCategory.const_662,AvatarEditorFigureCategory.const_890,AvatarEditorFigureCategory.const_99];
         super();
         ...
         if(var_1135 == null)
         {
            ...
            var_1135 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1386 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1386 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_395 = new Timer(1000);
         this.var_395.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1340;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_395.stop();
            this.var_395.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_395 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1340);
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2561 = this.canChangeOutfit();
            this.var_395.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_487 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_487.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_487.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1134.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_487.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_487.numSelectables)
               {
                  this.var_487.getSelectableAt(_loc6_).x = this.var_487.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1340;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1817 == AvatarEditorSideCategory.const_99 || this.var_2560))
         {
      ...
      {
         if(this.var_1817 == AvatarEditorSideCategory.const_99)
         {
            this.var_2560 = false;
            this.setSideContent(AvatarEditorSideCategory.const_580);
         }
         else
         {
            this.setSideContent(AvatarEditorSideCategory.const_99);
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_580:
               break;
            case AvatarEditorSideCategory.const_480:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_480);
               break;
            case AvatarEditorSideCategory.const_99:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_99);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_315 = param1;
         this.var_487.setSelected(this.var_487.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_488)
         {
            ...
            this.var_488 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_488.procedure = this.stripClubDialogEventProc;
            this.var_488.center();
         }
         else
         {
