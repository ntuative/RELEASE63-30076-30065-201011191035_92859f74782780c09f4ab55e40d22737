package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1680:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1680 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2353 = parseInt(param1.@precedence);
         this.var_2352 = String(param1.@activepartset);
         this.var_2354 = String(param1.@assetpartdefinition);
         this.var_2350 = String(param1.@lay);
         this.var_631 = String(param1.@geometrytype);
         this.var_2263 = Boolean(parseInt(param1.@main));
         this.var_2351 = Boolean(parseInt(param1.@name_3));
         this.var_2355 = Boolean(parseInt(param1.@animation));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_690.getValue(param1) == null)
         {
            this.var_690.add(param1,new Map());
         }
         var _loc4_:Map = this.var_690.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_690.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1680[param1];
         if(_loc2_ == null)
         {
