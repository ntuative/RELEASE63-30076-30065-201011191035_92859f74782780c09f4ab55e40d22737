package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this.var_574 && this.var_1308)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_82,this.var_849,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_32,parseInt(FigureData.const_702));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this._controller.handler.saveWardrobeOutfit(this.var_1673,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_574)
               {
                  this._controller.loadAvatarInEditor(this.var_574,this.var_849,this._controller.clubMemberLevel);
               }
         }
      }
