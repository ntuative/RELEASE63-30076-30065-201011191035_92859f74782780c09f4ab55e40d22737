package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_2385:String = null;
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_272.length == 1 && this.var_82 == this.var_2579)
         {
            return this.var_82 + this.var_581 + this.var_643 % 4;
         }
         if(this.var_272.length == 2)
         {
            for each(_loc1_ in this.var_272)
            {
               ...
               {
                  return this.var_82 + this.var_581 + 0;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2384 || param2 != this.var_2385 || param1 != this.var_2383)
         {
            this.var_2384 = param3;
            this.var_2385 = param2;
            this.var_2383 = param1;
            this.var_1700 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_250.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1153 || this.var_39 == null || (this.var_39.width != _loc5_.width || this.var_39.height != _loc5_.height))
         {
            if(this.var_39 != null && !this.var_1153)
            {
               this.var_39.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_250.definition.geometryType,this.var_82);
         this.var_39.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_643);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_643);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_281.push(new ActiveActionData(param1,param2,this.var_643));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_782);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_272)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_581 = "";
         this.var_272 = this._structure.sortActions(this.var_281);
         if(this.var_272 == null)
         {
         ...
         {
            this.var_690 = this._structure.getCanvasOffsets(this.var_272,this._scale,this.var_82);
            for each(_loc4_ in this.var_272)
            {
               this.var_581 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_285)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1315 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1315 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_272)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_293 || _loc1_.actionType == AvatarAction.const_211 || _loc1_.actionType == AvatarAction.const_361)
               {
                  this.var_783 = true;
               }
            }
