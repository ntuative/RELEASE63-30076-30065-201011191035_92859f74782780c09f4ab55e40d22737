package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1133:String = "Default";
      ...
      private var var_782:IActiveActionData;
      
      private var _assets:AssetAliasCollection;
      
      private var var_217:AvatarImageCache;
      
      private var var_643:int = 0;
      
      private var var_1522:int = 0;
      
      private var var_574:AvatarFigureContainer;
      
      private var var_582:Boolean;
      
      private var var_183:Array;
      
      private var var_500:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         if(this._scale == null)
         {
            this._scale = AvatarScaleType.const_50;
         }
         ...
         this.var_574 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_574.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1214 = this.var_1212;
         this.var_217 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1132,const_1134);
         this.var_281 = new Array();
         this.var_782 = new ActiveActionData(AvatarAction.const_325);
         this.var_782.definition = this._structure.getActionDefinition(const_1133);
         this.resetActions();
      }
      ...
      {
         var _loc3_:* = null;
         param2 += this.var_1522;
         if(param2 < AvatarDirectionAngle.const_956)
         {
         ...
         {
            if((this.var_82 == 6 || this.var_82 == 0) && param2 == 7)
            {
               param2 = this.var_82;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1214);
            if(_loc3_ != null)
            {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_643,param1.id);
      }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_250.definition.geometryType);
         if(this.var_39 == null || _loc4_ != null && (this.var_39.width != _loc4_.width || this.var_39.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_250.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_250.definition.geometryType,this.var_82);
         this.var_39.lock();
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_643);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_574,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1214 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_643);
                  _loc20_ = this.var_82;
                  _loc21_ = 1;
                  switch(this.var_82)
                  {
                  ...
                  if(_loc22_ != null)
                  {
                     ...
                     _loc11_.y += _loc22_.y;
                     if(this.var_82 == 7 && _loc12_.getDirection() == 6)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_82 == 4 && _loc12_.getDirection() == 3)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                     else if(this.var_82 == 3 && _loc12_.getDirection() == 4)
                     {
                        _loc11_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_82 == 6 && _loc12_.getDirection() == 7)
                     {
                        _loc11_.offset(_loc17_,0);
                     }
                  }
         ...
         {
            if(this.var_500.paletteIsGrayscale)
            {
               ...
               this.var_39 = _loc23_;
               this.var_39.paletteMap(this.var_39,this.var_39.rect,new Point(0,0),this.var_500.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_250.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_643);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_574,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_82)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_643);
                  _loc21_ = this.var_82;
                  _loc22_ = 1;
                  switch(this.var_82)
                  {
                  ...
                  if(_loc23_ != null)
                  {
                     ...
                     _loc12_.y += _loc23_.y;
                     if(this.var_82 == 7 && _loc13_.getDirection() == 6)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_82 == 4 && _loc13_.getDirection() == 3)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                     else if(this.var_82 == 3 && _loc13_.getDirection() == 4)
                     {
                        _loc12_.offset(-1 * _loc17_,0);
                     }
                     else if(this.var_82 == 6 && _loc13_.getDirection() == 7)
                     {
                        _loc12_.offset(_loc17_,0);
                     }
                  }
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_581 = this.var_581 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_281.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_500 = null;
         this.var_1522 = 0;
         this.var_250 = this.var_782;
         this.var_250.definition = this.var_782.definition;
         this.setActionToParts(this.var_782);
         this.getCache().resetBodyPartCache(this.var_782);
         return true;
      }
      ...
      {
         this.var_1213 = true;
         if(this.var_1314 == this.var_581)
         {
            return;
         }
         this.var_1314 = this.var_581;
         this.var_1215 = this._structure.sortActions(this.var_281);
         if(this.var_1215 == null)
         {
            this.var_690 = new Array(0,0,0);
         }
         else
         {
            this.var_690 = this._structure.getCanvasOffsets(this.var_1215,this._scale,this.var_82);
         }
      }
         ...
         for each(_loc1_ in this.var_1215)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     this.var_183 = this.var_183.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_1522 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_500 = _loc2_.avatarData;
                     }
                  }
               }
