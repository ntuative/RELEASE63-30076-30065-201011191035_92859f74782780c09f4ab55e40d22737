package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            this.var_1104 = _loc4_.content as BitmapData;
         }
         if(this._window != null)
         {
            this.var_371 = this._window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      
      public function udpate(param1:BitmapData) : void
      {
         if(this.var_371 && this.var_1104)
         {
            this.var_371.bitmap = new BitmapData(this.var_371.width,this.var_371.height,true,16777215);
            this.var_371.bitmap.copyPixels(this.var_1104,this.var_1104.rect,new Point(0,this.var_371.height - this.var_1104.height - 8));
            this.var_371.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
