   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_146,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_138,this.onBadgeImage);
            }
            if(this._container.roomSessionManager != null)
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_143,this.onFigureUpdate);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_146,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_138,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_143,this.onFigureUpdate);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_669.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_669.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_313);
         _loc1_.push(RoomWidgetUserActionMessage.const_781);
         _loc1_.push(RoomWidgetUserActionMessage.const_774);
         _loc1_.push(RoomWidgetUserActionMessage.const_632);
         _loc1_.push(RoomWidgetUserActionMessage.const_678);
         _loc1_.push(RoomWidgetUserActionMessage.const_704);
         _loc1_.push(RoomWidgetUserActionMessage.const_497);
         _loc1_.push(RoomWidgetUserActionMessage.const_782);
         _loc1_.push(RoomWidgetUserActionMessage.const_642);
         _loc1_.push(RoomWidgetUserActionMessage.const_801);
         _loc1_.push(RoomWidgetUserActionMessage.const_596);
         _loc1_.push(RoomWidgetUserActionMessage.const_646);
         _loc1_.push(RoomWidgetFurniActionMessage.const_298);
         _loc1_.push(RoomWidgetFurniActionMessage.const_720);
         _loc1_.push(RoomWidgetFurniActionMessage.const_696);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_698);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_655);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1479);
         _loc1_.push(RoomWidgetPetCommandMessage.const_748);
         _loc1_.push(RoomWidgetPetCommandMessage.const_637);
         _loc1_.push(RoomWidgetUserActionMessage.const_487);
         _loc1_.push(RoomWidgetUserActionMessage.const_328);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_443)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_328 || param1.type == RoomWidgetUserActionMessage.const_487 || param1.type == RoomWidgetUserActionMessage.const_415)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_704:
               ...
               break;
            case RoomWidgetUserActionMessage.const_497:
               this._container.roomSession.kickUser(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_782:
            ...
            case RoomWidgetUserActionMessage.const_801:
               ...
               break;
            case RoomWidgetUserActionMessage.const_596:
               ...
               break;
            case RoomWidgetUserActionMessage.const_646:
            ...
            case RoomWidgetUserActionMessage.const_328:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_698:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_655:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_648);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_324);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1045);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1078);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_251)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_330)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1090)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_446);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_208)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_226)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_578);
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_999;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_984;
                  }
                  _loc28_ = this._container.sessionDataManager.userId;
                  _loc29_ = this._container.sessionDataManager.method_5(_loc28_);
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1321);
               }
               else
               {
               ...
               _loc18_ = _loc11_.sex;
               _loc19_ = this._container.avatarRenderManager.createAvatarImage(_loc17_,AvatarScaleType.const_50,_loc18_);
               if(_loc19_ != null)
               {
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_330)
               {
                  _loc31_ = this._container.sessionDataManager.method_5(_loc11_.webID);
      ...
      private function onFigureUpdate(param1:RoomSessionUserFigureUpdateEvent) : void
      {
         ...
         {
            _loc5_ = this._container.avatarRenderManager.createAvatarImage(param1.figure,AvatarScaleType.const_50,param1.gender);
            if(_loc5_ != null)
            {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_669.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_50);
            this.var_669.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_578);
