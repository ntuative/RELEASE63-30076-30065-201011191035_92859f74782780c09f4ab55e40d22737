package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      public static const const_514:int = -1;
      ...
      private var var_1003:IRoomWidgetFactory = null;
      
      private var var_394:ISessionDataManager = null;
      
      private var var_19:IRoomSessionManager = null;
      
      private var var_426:IAvatarRenderManager = null;
      ...
      private var var_1074:IHabboHelp = null;
      ...
      private var var_28:IRoomSession = null;
      ...
      private var var_1575:Boolean = true;
      
      private var var_657:Array;
      
      private var var_197:IToolTipWindow;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         this.var_177 = new DesktopLayoutManager();
      }
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_296,this.processEvent);
         }
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_338,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_441,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_659,this.onRoomContentLoaded);
         }
      }
      ...
      {
         this.var_177.setLayout(param1,this._windowManager);
         if(this._toolbar != null)
         {
            this.var_177.toolbarSize = this._toolbar.size;
            this.var_177.toolbarOrientation = this._toolbar.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this._roomEngine != null && this.var_28 != null)
         {
            _loc2_ = this._roomEngine.getRoomCanvasGeometry(this.var_28.roomId,this.var_28.roomCategory,this.getFirstCanvasId());
            if(_loc2_ != null)
            {
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_296,this.processEvent);
         }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_338,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_441,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_659,this.onRoomContentLoaded);
         }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_28 != null)
         {
            this.var_657 = this._roomEngine.loadRoomResources(this.var_28.roomResources);
            if(this.var_657.length > 0)
            {
               this.var_1575 = false;
               this.processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_101));
            }
         }
         if(this.var_274 != null && this.var_28.state == RoomSessionEvent.const_216)
         {
            this.var_1574 = !this.var_274.showInterstitial();
         }
      ...
      {
         if(this.var_657 == null || this.var_657.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_657.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_657.splice(_loc2_,1);
         }
         if(this.var_657.length == 0)
         {
            this.var_1575 = true;
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1003.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_177.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               {
                  _loc6_ = this.var_655.getValue(_loc9_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_655.add(_loc9_,_loc6_);
                  }
                  else
                  {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = this.var_656.getValue(_loc10_);
                  if(_loc6_ == null)
                  {
                     _loc6_ = [];
                     this.var_656.add(_loc10_,_loc6_);
                  }
                  _loc6_.push(_loc3_);
               }
            }
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,this.var_177.roomViewRect);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_655.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_656.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_641:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_351,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(this.var_869 != null && _loc3_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc7_ = this.var_28.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_330)
                  {
                     this.var_869.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_268:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_469:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_215,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_725:
               if(!this.var_28.isRoomController && !this.var_394.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_132:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1005,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_451:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_113,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineEvent.const_482:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_921,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc21_:* = null;
         var _loc2_:Rectangle = this.var_177.roomViewRect;
         ...
         if(this.var_28 == null || this._windowManager == null || this._roomEngine == null)
         {
            return;
         }
         var _loc6_:DisplayObject = this._roomEngine.createRoomCanvas(this.var_28.roomId,this.var_28.roomCategory,param1,_loc3_,_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         var _loc7_:RoomGeometry = this._roomEngine.getRoomCanvasGeometry(this.var_28.roomId,this.var_28.roomCategory,param1) as RoomGeometry;
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_28.roomId,this.var_28.roomCategory,RoomVariableEnum.const_722);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_28.roomId,this.var_28.roomCategory,RoomVariableEnum.const_792);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_28.roomId,this.var_28.roomCategory,RoomVariableEnum.const_755);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_28.roomId,this.var_28.roomCategory,RoomVariableEnum.const_668);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_281,this.canvasMouseHandler);
         ...
         if(this.var_28.isSpectatorMode)
         {
         ...
         this.var_177.addRoomView(_loc9_);
         this.var_262.push(param1);
         var _loc12_:String = this._roomEngine.getWorldType(this.var_28.roomId,this.var_28.roomCategory);
      ...
      {
         var _loc3_:IWindowContainer = this.var_177.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function getRoomViewRect() : Rectangle
      {
         ...
         return this.var_177.roomViewRect;
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            this._roomEngine.setActiveRoom(this.var_28.roomId,this.var_28.roomCategory);
            this._roomEngine.handleRoomCanvasMouseEvent(this.var_262[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_197 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_197.width / 2,15);
            this.var_197.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this._roomEngine.modifyRoomCanvas(this.var_28.roomId,this.var_28.roomCategory,this.var_262[0],_loc2_.width,_loc2_.height);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.var_177.toolbarOrientation = param1.orientation;
         }
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1576) / 1000);
      ...
      {
         if(this.var_19 != null && this.var_28 != null && this.var_1574 && this.var_1575)
         {
            this.var_19.startSession(this.var_28);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_367);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_528:
               ...
               this.var_197 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_371,WindowStyle.const_587,WindowParam.const_95) as IToolTipWindow;
               this.var_197.setParamFlag(WindowParam.const_46,false);
