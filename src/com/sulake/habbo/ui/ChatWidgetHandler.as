package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_641:Point = null;
      
      private var var_422:Vector3d;
      ...
      {
         return RoomWidgetEnum.const_331;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_353.length)
            {
               _loc2_ = this.var_353.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_352 != null)
         {
            ...
            {
               _loc2_ = this.var_352.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_675,RoomWidgetChatSelectAvatarMessage.const_562];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_675:
               if(this._container != null && this._container.roomSession != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     {
                        case RoomWidgetChatMessage.const_140:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_562:
      ...
      {
         return [RoomSessionChatEvent.const_168];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_168:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc10_.type == RoomObjectTypeEnum.const_251)
                           {
                              _loc13_ = this.var_352.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_353.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_780.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_251:
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_251)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_352.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_353.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_780.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_972 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_972);
            }
            if(this.var_641 == null)
            {
               ...
               this.var_422.y = 0;
               this.var_422.z = 0;
               this.var_641 = _loc4_.getScreenPoint(this.var_422);
               this.var_972 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_422.x = 0;
            this.var_422.y = 0;
            this.var_422.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_422);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_641.x || _loc8_.y != this.var_641.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_641,_loc5_));
