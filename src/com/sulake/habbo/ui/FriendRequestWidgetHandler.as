package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_797);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_599);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_667);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_797:
               ...
               if(_loc4_)
               {
                  _loc5_ = this._container.roomEngine.getRoomObjectBoundingRectangle(_loc3_.roomId,_loc3_.roomCategory,_loc4_.id,RoomObjectCategoryEnum.const_34,this._container.getFirstCanvasId());
            ...
            case RoomWidgetFriendRequestMessage.const_599:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_667:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_135);
         _loc1_.push(FriendRequestEvent.const_41);
         _loc1_.push(FriendRequestEvent.const_296);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_135:
            ...
            case FriendRequestEvent.const_296:
