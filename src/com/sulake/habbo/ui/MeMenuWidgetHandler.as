   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_767,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_431,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_115,this.onHelpTutorialEvent);
            }
            this._container = null;
         }
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_767,this.onFigureUpdate);
            this._container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_185,this.onCreditBalance);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_873,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1020,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_431,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_115,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1366)
            {
               _loc4_ = this._container.sessionDataManager.gender;
               _loc5_ = this._container.avatarRenderManager.createAvatarImage(_loc3_,AvatarScaleType.const_50,_loc4_,this);
               if(_loc5_ != null)
               {
               ...
               this.var_1366 = _loc3_;
               this.var_1785 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1785;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_946,HabboToolbarIconEnum.MEMENU);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_680);
         _loc1_.push(RoomWidgetDanceMessage.const_595);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_776);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_768);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_763);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_583);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_670);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_601);
         _loc1_.push(RoomWidgetStopEffectMessage.const_761);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1338);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1079);
         _loc1_.push(RoomWidgetToolbarMessage.const_802);
         _loc1_.push(RoomWidgetToolbarMessage.const_617);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_347);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1341);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1051);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_800);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_715);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_552);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1440);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_758);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_631);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_706);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_376);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_715:
               ...
               break;
            case RoomWidgetWaveMessage.const_680:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_595:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_776:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_768:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_763:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_601:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_882)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_165,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_670:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1004:
                        this._catalog.openCatalogPage(CatalogPageName.const_1227,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_883:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_256);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1292:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_80);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1446:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_583:
            case RoomWidgetStopEffectMessage.const_761:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1079:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_800:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_802:
               ...
               break;
            case RoomWidgetToolbarMessage.const_617:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_444,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_347:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_529));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_552:
            ...
            case RoomWidgetStoreSettingsMessage.const_758:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_350,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_631:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_350,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_706:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_395));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_376:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_650));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_115:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_115));
               break;
            case HabboHelpTutorialEvent.const_431:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_447));
         }
      }
