package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_968;
         if(this.var_968 < this.var_776.length)
         {
            _loc1_ = this.var_776[this.var_968] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_776.length);
                  _loc2_.text = _loc6_;
               }
            ...
            if(_loc2_)
            {
               ...
               while(_loc3_ < _loc2_.numListItems)
               {
                  ...
                  if(_loc4_)
                  {
                     ...
                     if(_loc5_)
                     {
                        if(_loc5_.testStateFlag(WindowState.const_52))
                        {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_350)
         {
            ...
            this.var_350 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_350.center();
            this.var_350.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_776[this.var_968] as Dictionary;
