package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_754 = this.var_202.findChildByTag("catalog");
         if(this.var_754 != null)
         {
            this.var_754.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_49.getListItemByName("image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_49.getListItemByName("description_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_49.getListItemByName("expiration_text") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_49.getListItemByName("expiration_spacer") as IWindowContainer;
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            if(!this.var_49.getListItemByName("catalog_button"))
            {
               this.var_49.addListItem(this.var_754);
            }
            this.var_754.visible = param1;
         }
         else
         {
            this.var_49.removeListItem(this.var_754);
         }
      }
   }
}
