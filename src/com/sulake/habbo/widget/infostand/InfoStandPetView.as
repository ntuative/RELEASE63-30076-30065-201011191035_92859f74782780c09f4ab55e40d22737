package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_1316:Map;
      
      private var var_523:int;
      
      private const const_1795:int = 158;
      
      private const const_1796:int = 16;
      
      private const const_1792:uint = 11184810;
      
      private const const_1789:uint = 6710886;
      
      private const const_1788:uint = 3355443;
      
      private const const_1794:String = "level";
      
      private const const_1790:String = "experience";
      
      private const const_1793:String = "energy";
      
      private const const_1791:String = "nutrition";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1794,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1790,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1793,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1791,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_523 = param1.id;
         this.var_1316.remove(param1.id);
         this.var_1316.add(param1.id,param1);
         if(this.var_179 && this.var_179.isVisible() && param1.isOwnPet)
         {
            this.var_179.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         this.var_179.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1795,this.const_1796,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1792);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1788);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1789);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         if(this.var_179 == null)
         {
            this.var_179 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1316.getValue(this.var_523) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_179.showWindow(true);
            this.var_179.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_202.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_49.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = this.var_49.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = this.var_49.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_49.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = this.var_49.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_179 && this.var_179.getPetId() == this.var_523)
               {
                  this.var_179.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_497,this._widget.petData.ownerId);
