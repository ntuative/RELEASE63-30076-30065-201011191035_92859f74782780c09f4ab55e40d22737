package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_49:IItemListWindow;
      ...
      private var var_121:IBorderWindow;
      ...
      {
         if(this.var_49 == null || this.var_202 == null || this.var_63 == null)
         {
            return;
         }
         this.var_63.width = this.var_63.scrollableRegion.width;
         this.var_49.height = this.var_49.scrollableRegion.height;
         this.var_202.height = this.var_49.height + 20;
         this._window.width = Math.max(this.var_202.width,this.var_63.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_202.width < this.var_63.width)
         {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         {
            this.var_49 = this.var_202.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         var _loc6_:IBitmapWrapperWindow = this.var_202.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = this.var_202.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = this.var_202.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = this.var_202.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_121.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_121.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_121.x = _loc5_.left - this.var_121.width;
         this.var_121.y = _loc5_.top + (_loc5_.height - this.var_121.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_121.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = this.var_121.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_121.x = _loc7_.left - this.var_121.width;
         this.var_121.y = _loc7_.top + (_loc7_.height - this.var_121.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_121 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_121 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_49.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_49.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = this.var_49.getListItemByName("image_and_badges_container") as IWindowContainer;
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_49.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_49.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = this.var_49.getListItemByName("score_value") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:ITextWindow = this.var_49.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_49.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_49.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = this.var_49.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:IWindowContainer = this.var_49.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = this.var_49.getListItemByName("tags_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = this.var_49.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc3_:* = null;
         var _loc1_:IWindowContainer = this.var_49.getListItemByName("image_and_badges_container") as IWindowContainer;
         var _loc2_:int = 0;
         while(_loc2_ < 5)
         {
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_208:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_226:
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_999:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_984:
