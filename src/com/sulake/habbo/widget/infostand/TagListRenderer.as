package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1802:int = 5;
      ...
      private var var_1127:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1128 = 0;
         this.var_1127 = param2.rectangle.clone();
         this.var_1127.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1127.width)
         {
            return false;
         }
         if(this.var_1128 + param1.height > this.var_1127.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1127.width)
         {
            this._offsetX = 0;
            this.var_1128 += param1.height + this.const_1803;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1128);
         this._offsetX += param1.width + this.const_1802;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1381 != null && this.var_1381.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_130);
