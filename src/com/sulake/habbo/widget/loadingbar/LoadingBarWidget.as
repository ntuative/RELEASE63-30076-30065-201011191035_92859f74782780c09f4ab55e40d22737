package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_419:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_419.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_419 = null;
         }
         if(this.var_39 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_101,this.onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_101,this.onShowLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_101,this.onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_101,this.onShowLoadingBar);
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_419 == null)
         {
            this.var_419 = new Sprite();
            this.var_419.addChild(new Bitmap(this.var_39));
            this.var_419.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_419.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_39;
            }
         }
         _loc2_.setDisplayObject(this.var_419);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_101)
         {
            return;
         }
         if(!this.createWindow())
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1159 != "")
         {
            HabboWebTools.openWebPage(this.var_1159);
         }
      }
   }
}
