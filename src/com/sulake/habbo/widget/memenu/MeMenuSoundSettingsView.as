package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_821:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_429 = param1.volume;
         if(this.var_821 != null)
         {
            this.var_821.setValue(this.var_429);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1615 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1612 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1614 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1613 = (_loc5_.content as BitmapData).clone();
         }
         this.var_821 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_552));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_429 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1615);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1612);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_429 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1614);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1613);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_631);
         }
