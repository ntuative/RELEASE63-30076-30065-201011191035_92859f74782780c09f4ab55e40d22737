package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      {
         this.var_133 = new Dictionary();
         this.var_133["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_133["dance_icon"] = ["dance_white","dance_color"];
         this.var_133["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_133["effects_icon"] = ["effects_white","effects_color"];
         this.var_133["badges_icon"] = ["badges_white","badges_color"];
         this.var_133["wave_icon"] = ["wave_white","wave_color"];
         this.var_133["hc_icon"] = ["_white","_color"];
         this.var_133["settings_icon"] = ["settings_white","settings_color"];
         this.var_133["credits_icon"] = ["credits_white","credits_color"];
         this.var_133["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_133[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_133[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_133[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc3_ in this.var_133)
         {
            _loc6_ = this.var_133[_loc3_];
            if(!(_loc6_ == null || _loc6_.length == 0))
            {
               ...
               switch(_loc3_)
               {
                  ...
                  case "hc_icon":
                     ...
                     {
                        if(this._widget.habboClubLevel == HabboClubLevelEnum.const_55)
                        {
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_932);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_981));
            ...
            case "effects":
               ...
               this._widget.changeView(MeMenuWidget.const_622);
               break;
            case "rooms":
               ...
               break;
            case "badges":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_883));
               this._widget.hide();
               break;
            case "clothes":
               this._widget.changeView(MeMenuWidget.const_306);
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_882));
               this._widget.hide();
               break;
            case "settings":
               this._widget.changeView(MeMenuWidget.const_636);
               break;
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = this._widget.config.getKey("client.credits.embed.enabled","false") == "HabboWindowManagerCom_habbo_window_alert_xml";
               if(false && _loc4_)
               {
