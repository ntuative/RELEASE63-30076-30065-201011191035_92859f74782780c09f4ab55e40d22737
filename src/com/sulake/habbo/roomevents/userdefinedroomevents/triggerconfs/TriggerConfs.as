package com.sulake.habbo.roomevents.userdefinedroomevents.triggerconfs
{
   ...
   public class TriggerConfs implements ElementTypeHolder
   {
      ...
      public function TriggerConfs()
      {
         ...
         super();
         this.var_224.push(new AvatarSaysSomething());
         this.var_224.push(new AvatarEntersStuff());
         this.var_224.push(new AvatarExitsStuff());
         this.var_224.push(new TriggerOnce());
         this.var_224.push(new StuffIsUsed());
         this.var_224.push(new TriggerPeriodically());
         this.var_224.push(new AvatarEntersRoom());
         this.var_224.push(new GameStarts());
         this.var_224.push(new GameEnds());
         this.var_224.push(new ScoreAchieved());
      }
