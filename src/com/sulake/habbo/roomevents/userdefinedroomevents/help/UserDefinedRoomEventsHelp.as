package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_988:IContainerButtonWindow;
      
      private var var_987:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1537 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_987 = this.var_1537.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_987)
         {
            this.var_987.procedure = this.onButtonClick;
         }
         this.var_988 = this.var_1537.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_988)
         {
            this.var_988.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_222 >= this._localizations.length - 1)
         {
            this.var_988.disable();
         }
         else
         {
            this.var_988.enable();
      ...
      {
         ++this.var_222;
         this.var_222 = Math.min(this.var_222,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_222;
         this.var_222 = Math.max(this.var_222,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_222][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_222][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_222][1]).value;
