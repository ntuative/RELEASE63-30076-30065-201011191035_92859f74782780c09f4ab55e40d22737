package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1750:TriggerConfs;
      
      private var var_1748:ActionTypes;
      
      private var var_1749:ConditionTypes;
      
      private var var_241:Dictionary;
      
      private var var_58:Triggerable;
      
      private var var_702:RoomObjectHightLighter;
      
      private var var_165:UserDefinedRoomEventsHelp;
      
      private var var_1097:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1750 = new TriggerConfs();
         this.var_1748 = new ActionTypes();
         this.var_1749 = new ConditionTypes();
         this.var_241 = new Dictionary();
         super();
         this.var_86 = param1;
         this.var_702 = new RoomObjectHightLighter(param1);
         this.var_165 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_87 = IWindowContainer(this.find(this._window,"configure_container"));
         Util.setProcDirectly(this.find(this.var_87,"save_button"),this.onSave);
         Util.setProcDirectly(this.find(this.var_87,"cancel_save_button"),this.onWindowClose);
         Util.setProcDirectly(this.find(this.var_87,"helplink"),this.onHelp);
         Util.setProcDirectly(this.find(this.var_87,"apply_snapshot_txt"),this.onApplySnapshot);
         this.find(this.var_87,"helplink").mouseTreshold = 0;
         this.find(this.var_87,"apply_snapshot_txt").mouseTreshold = 0;
         this.var_1097 = new SliderWindowController(this.var_86,IWindowContainer(this.find(this.var_87,"delay_slider_container")),this.var_86.assets,0,20,1);
         this.var_1097.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1097.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_702.hideAll(this.var_241);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_702.showAll(this.var_241);
         if(this.var_58 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_58);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1097.setValue(_loc6_);
         }
         this.refresh();
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_58 as TriggerDefinition != null)
         {
            this.var_86.send(new UpdateTriggerMessageComposer(this.var_58.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_58 as ActionDefinition != null)
         {
            this.var_86.send(new UpdateActionMessageComposer(this.var_58.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_58 as ConditionDefinition != null)
         {
            this.var_86.send(new UpdateConditionMessageComposer(this.var_58.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1097.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_165.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_86.send(new ApplySnapshotMessageComposer(this.var_58.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1750);
         this.refreshConfigureElement(this.var_1748);
         this.refreshConfigureElement(this.var_1749);
      ...
      private function refreshConfigureElement(param1:ElementTypeHolder) : void
      {
         ...
         {
            this.find(this.var_87,param1.getKey() + "_icon_bitmap").visible = false;
            return;
         }
         ...
         this.find(this.var_87,"warning_container").visible = false;
         this.refreshConflictingTriggers();
         this.refreshConflictingActions();
         this.refreshActionInputs();
         Util.moveAllChildrenToColumn(this.var_87,3,5);
         this.var_87.height = Util.getLowestPoint(this.var_87) + 1;
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_87,"header_container"));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_87,"action_inputs_container"));
         if(this.var_58 as ActionDefinition == null)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_87,"warning_container"));
         ...
         _loc3_.height = Util.getLowestPoint(_loc3_) + 4;
         this.find(this.var_87,"warning_container").visible = true;
      }
      
      private function refreshCustomInputs() : void
      {
         var _loc2_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_87.findChildByName("custom_inputs_container"));
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         var _loc2_:Element = this.resolveType();
         var _loc3_:IWindowContainer = IWindowContainer(this.var_87.findChildByName("custom_inputs_container"));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_87.findChildByName("select_furni_container"));
         if(!this.isStuffSelectionMode())
         {
            _loc1_.visible = false;
            return;
