package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1787:String = "type_sound_machine";
      
      private const const_1528:String = "type_jukebox";
      
      private var var_577:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._connection.addMessageEvent(new PlayListSongAddedMessageEvent(this.include));
         this._events.addEventListener(SoundCompleteEvent.const_619,this.onSongFinishedPlayingEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_719,this.onSoundMachinePlayEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_710,this.onSoundMachineStopEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_721,this.onJukeboxInitEvent);
         this.var_86.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_408,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_619,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_86)
            {
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_719,this.onSoundMachinePlayEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_710,this.onSoundMachineStopEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_721,this.onJukeboxInitEvent);
               this.var_86.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_408,this.onDisposeEvent);
               this.var_86 = null;
            }
            if(this.var_368)
            {
      ...
      {
         this.startPlaying(this.const_1787);
      }
      ...
      {
         this.startPlaying(this.const_1528);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_271 = _loc2_.id;
            this.playSong(this.var_271);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_368[this.var_271] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_368.getValue(this.var_271) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_271 = param1;
         var _loc2_:IHabboSound = this.var_368.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_577.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_577.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_271)
         {
            _loc6_ = this.var_368[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1679 == this.const_1528)
         {
            this.var_73.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_576.indexOf(param1) == -1)
         {
            this.var_576.push(param1);
         }
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_576 = this.var_576.splice(this.var_576.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_368[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_577.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_368.add(_loc3_.id,_loc7_);
            }
            this.checkSongPlayState(_loc3_.id);
         }
      }
      
      private function include(param1:IMessageEvent) : void
      {
