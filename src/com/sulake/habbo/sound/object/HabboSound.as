package com.sulake.habbo.sound.object
{
   ...
   public class HabboSound implements IHabboSound
   {
      ...
      public function HabboSound(param1:Sound)
      {
         super();
         this.var_989 = param1;
         this.var_989.addEventListener(Event.COMPLETE,this.onComplete);
         this.var_429 = 1;
         this.var_1230 = false;
      }
      ...
      {
         this.var_1230 = false;
         this._soundChannel = this.var_989.play(0);
         this.volume = this.var_429;
         return true;
      }
      ...
      {
         return !this.var_989.isBuffering;
      }
