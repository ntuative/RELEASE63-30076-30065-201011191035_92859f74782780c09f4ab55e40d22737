package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         this.var_684 = main.component.userRegistry.getRegistry();
         if(this.var_684.length == 0)
         {
            main.showUI(HabboHelpViewEnum.const_144);
         ...
         while(i < this.var_684.length)
         {
            ...
            item = this.buildListEntryItem(t,this.windowProcedure);
            if(item != null)
            {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > this.var_684.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = this.var_684.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_ > -1)
         {
            main.showUI(HabboHelpViewEnum.const_345);
         }
      }
