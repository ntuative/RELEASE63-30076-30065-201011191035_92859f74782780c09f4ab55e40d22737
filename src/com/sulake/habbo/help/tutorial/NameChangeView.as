package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1282:uint = 13232628;
      
      private static var var_1641:uint = 11129827;
      ...
      private var var_1640:IWindowContainer;
      ...
      private var var_1046:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1640 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_675)
         {
            this.var_675 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_675)
            {
               return;
            }
         ...
         var _loc1_:ITextWindow = this.var_675.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_456;
         }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_456);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_735:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_736:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_913 || param1 == ChangeUserNameResultMessageEvent.var_912)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1046 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1046.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1282;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_1283)
         {
            if(param1.type == WindowEvent.const_108)
            {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_456 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_456);
               break;
            ...
            case "header_button_close":
               this._controller.showView(TutorialUI.const_88);
         }
      }
