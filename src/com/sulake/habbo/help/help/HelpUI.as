package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1523:int = 0;
      
      private static const const_1524:int = 0;
      ...
      private var var_462:IWindowContainer;
      ...
      {
         this.var_315 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201011191030));
         this._toolbar = param5;
         this.var_95 = new Map();
         this.var_95.add(HabboHelpViewEnum.const_1475,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_144,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_502,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_263,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_202,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_723,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_345,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_759,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_225,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_95.add(HabboHelpViewEnum.const_914,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_95.add(HabboHelpViewEnum.const_1042,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_95.add(HabboHelpViewEnum.const_691,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_686.length == 0 || param1 != this.var_315)
            {
               this.var_686.push(this.var_315);
            }
         }
         this.var_315 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_315);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_225:
               this.showUI(HabboHelpViewEnum.const_225);
               break;
            case CallForHelpResultEnum.const_1054:
               this.showUI(HabboHelpViewEnum.const_1042);
               break;
            case CallForHelpResultEnum.const_907:
               this.showUI(HabboHelpViewEnum.const_914);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_95.getValue(HabboHelpViewEnum.const_144) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_404));
      }
      ...
      {
         return this.var_95.getValue(this.var_315);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1669 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1670;
         this._window.width = _loc1_.width + this.var_1669;
      }
         ...
         switch(param1.type)
         {
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               ...
               if(param2.tags.indexOf("back") > -1)
               {
                  ...
                  {
                     this.showUI(this.var_686.pop(),false);
                  }
                  return;
               }
               break;
      ...
      {
         var _loc3_:* = null;
         if(this.var_315 == HabboHelpViewEnum.const_144)
         {
            return;
         }
         if(this.var_573.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_573.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_573.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_462.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_573[1],this.var_573[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_573[0],this.var_573[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_315 == HabboHelpViewEnum.const_144 || this.var_686.length == 0)
         {
            return;
         }
         if(this.var_462 == null)
         {
            ...
            this.var_462 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_462 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_462 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_462 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
