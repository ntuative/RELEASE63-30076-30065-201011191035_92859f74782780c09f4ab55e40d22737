package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.ROOMINFO));
            this.setToolbarExitIcon();
            this._navigator.roomInfoViewCtrl.open(false);
         }
         if(!_loc2_.guestRoom)
         {
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.enterRoom)
         {
            ...
            _loc4_ = _loc3_ || this.data.enteredGuestRoom.ownerName != this._navigator.sessionData.userName;
            if(_loc4_)
            {
               this._navigator.roomInfoViewCtrl.open(_loc3_);
            }
            if(!_loc3_)
            {
               this.requestRoomEnterAd();
      ...
      {
         if(this._navigator.configuration.getKey("roomenterad.habblet.enabled") == "HabboWindowManagerCom_habbo_window_alert_xml" && false)
         {
      ...
      private function setToolbarExitIcon() : void
      {
         ...
         {
            _loc1_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.EXITROOM);
         }
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_231);
      }
      ...
      private function onUserFlatCats(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:RoomsTabPageDecorator = RoomsTabPageDecorator(this._navigator.tabs.getTab(Tabs.const_209).tabPageDecorator);
