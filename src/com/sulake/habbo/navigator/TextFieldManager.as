package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_69.addEventListener(WindowKeyboardEvent.const_156,this.checkEnterPress);
         this.var_69.addEventListener(WindowEvent.const_108,this.checkMaxLen);
         this.var_2460 = this.var_69.textBackground;
         this._orgTextBackgroundColor = this.var_69.textBackgroundColor;
         this.var_2462 = this.var_69.textColor;
      }
      ...
      {
         this.var_69.textBackground = this.var_2460;
         this.var_69.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_69.textColor = this.var_2462;
      }
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_69.text = this.var_1192;
            this.var_596 = true;
         }
         else
         {
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_69.text = this.var_2461;
         this.var_596 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         {
            this.var_69.text = _loc2_.substring(0,this.var_1768);
         }
      }
   }
}
