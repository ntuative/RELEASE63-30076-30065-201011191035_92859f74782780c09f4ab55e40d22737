package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1293:CutToWidth = new CutToWidth();
      
      private static var var_1294:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1293.beforeSearch(param2,param1,param3);
         binarySearch(var_1293,param2.length - 1);
      }
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1294.beforeSearch(param2,param1,param3);
         binarySearch(var_1294,param2.length - 1);
      }
