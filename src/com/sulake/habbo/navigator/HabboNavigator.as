package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_261:MainViewCtrl;
      
      private var var_540:RoomInfoViewCtrl;
      
      private var var_1002:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_385:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2644:Dictionary;
      ...
      private var var_2184:RoomThumbnailRenderer;
      
      private var var_859:GuestRoomPasswordInput;
      
      private var var_295:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_261 = new MainViewCtrl(this);
         this.var_540 = new RoomInfoViewCtrl(this);
         this.var_1002 = new RoomCreateViewCtrl(this);
         this.var_2184 = new RoomThumbnailRenderer(this);
         this.var_859 = new GuestRoomPasswordInput(this);
         this.var_295 = new GuestRoomDoorbell(this);
         this.var_385 = new Tabs(this);
      ...
      public function goToRoom(param1:int, param2:Boolean, param3:String = "") : void
      {
         ...
         if(this.var_19)
         {
            ...
            this.var_540.close();
            this.var_19.gotoRoom(false,param1,param3);
         }
      }
      ...
      public function goToPublicSpace(param1:int, param2:String) : void
      {
         ...
         {
            this.var_540.close();
            this.var_19.gotoRoom(true,param1,"",param2);
         }
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_279,HabboWindowStyle.const_38,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_540.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_152.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_261.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_261.startSearch(Tabs.const_224,Tabs.const_372,param1);
         this.var_261.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_261.startSearch(Tabs.const_286,Tabs.const_231);
         this.var_385.getTab(Tabs.const_286).tabPageDecorator.tabSelected();
      }
