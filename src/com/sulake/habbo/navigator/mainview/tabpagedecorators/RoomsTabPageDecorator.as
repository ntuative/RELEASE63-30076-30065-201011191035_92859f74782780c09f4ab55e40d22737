package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_209,Tabs.const_322);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_209,Tabs.const_684);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_209,Tabs.const_322,"" + _loc3_);
         }
      }
   }
}
