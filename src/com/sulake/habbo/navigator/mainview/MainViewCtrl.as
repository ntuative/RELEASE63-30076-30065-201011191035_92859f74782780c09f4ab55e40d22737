package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_1550:int = 3;
      
      public static const const_1017:int = 4;
      
      private static const const_853:int = 1;
      
      private static const const_543:int = 2;
      
      private static const const_852:int = 3;
      ...
      private var var_878:PopularTagsListCtrl;
      
      private var var_879:GuestRoomListCtrl;
      
      private var var_1090:OfficialRoomListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_878 = new PopularTagsListCtrl(this._navigator);
         this.var_879 = new GuestRoomListCtrl(this._navigator);
         this.var_1090 = new OfficialRoomListCtrl(this._navigator);
         this.var_412 = new Timer(300,1);
         this.var_412.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_412)
            {
               this.var_412.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_412.reset();
               this.var_412 = null;
            }
            if(this.var_878)
      ...
      public function open() : void
      {
         ...
         if(_loc1_)
         {
            this._navigator.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_49,HabboToolbarIconEnum.NAVIGATOR,this.var_16));
         }
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_223 = ITabContextWindow(this.var_16.findChildByName("tab_context"));
         if(!this.var_223)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_166 = IWindowContainer(this.var_16.findChildByName("tab_content"));
         ...
         this.var_237 = IWindowContainer(this.var_16.findChildByName("custom_footer"));
         this.var_1331 = this.var_16.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_16.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1091 = IRegionWindow(this.var_16.findChildByName("to_hotel_view"));
         if(!this.var_1091)
         {
         ...
         {
            _loc3_ = this.var_223.getTabItemByID(_loc2_.id);
            if(!_loc3_)
            {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_573,false);
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_166,["custom_content","list_content"],this.var_205.y,8);
         this.var_181.height = this.var_181.height + _loc1_ - this.var_181.y - this.var_237.height + this.var_2420;
         Util.moveChildrenToColumn(this.var_166,["list_content","custom_footer"],this.var_181.y,0);
         this.var_2420 = this.var_237.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_223.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1731 = true;
            this.var_223.selector.setSelected(_loc1_.button);
         }
      }
      ...
      {
         this.refreshList(param1,param2,this.var_879,"guest_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_878,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1090,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_588 == const_853)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_181.blend - _loc2_));
            this.var_181.blend = _loc3_;
            this.var_205.blend = !!this.var_1089 ? Number(_loc3_) : Number(1);
            this.var_237.blend = !!this.var_1089 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_588 = const_543;
            }
         }
         else if(this.var_588 == const_543)
         {
            if(this.var_1330 % 10 == 1)
            {
               this.var_1331.visible = !this.var_1331.visible;
            }
            ++this.var_1330;
            if(!this._navigator.data.isLoading())
            {
               this.var_588 = const_852;
            }
         }
         else if(this.var_588 == const_852)
         {
            this.refresh();
            this.var_588 = const_1197;
         }
         else
         {
            this.var_1331.visible = false;
            _loc3_ = Math.min(1,Math.max(0,this.var_181.blend + _loc2_));
            this.var_181.blend = _loc3_;
            this.var_205.blend = !!this.var_1089 ? Number(_loc3_) : Number(1);
            this.var_237.blend = !!this.var_1089 ? Number(_loc3_) : Number(1);
      ...
      {
         this.refreshScrollbar(this.var_878);
