package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_586 = new Timer(100);
         this.var_586.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_36 = new Array();
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,104,"a"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,94,"b"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,36,"c"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,84,"d"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,80,"e"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,80,"f"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,416,"i"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,320,"j"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,448,"k"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,352,"l"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,384,"m"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_51,372,"n"));
         ...
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_55,540,"t"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_55,512,"w"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_55,396,"x"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_55,440,"y"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_55,456,"z"));
         this.var_36.push(new RoomLayout(HabboClubLevelEnum.const_55,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_586)
         {
            this.var_586.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_586.reset();
            this.var_586 = null;
         }
      }
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1721 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1721 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_52 = IItemListWindow(this.var_166.findChildByName("item_list"));
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_57,HabboWindowStyle.const_35,HabboWindowParam.const_59,new Rectangle(0,0,100,300)));
      }
