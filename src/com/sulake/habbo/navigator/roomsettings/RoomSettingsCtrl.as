package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_370:IRoomSettingsCtrlOwner;
      ...
      private var var_468:Boolean;
      
      private var var_692:TextFieldManager;
      
      private var var_1064:TextFieldManager;
      
      private var var_861:TextFieldManager;
      
      private var var_860:TextFieldManager;
      
      private var var_859:TextFieldManager;
      
      private var var_1066:TextFieldManager;
      
      private var var_1070:ICheckBoxWindow;
      
      private var var_1065:ICheckBoxWindow;
      
      private var var_1072:ICheckBoxWindow;
      
      private var var_578:ICheckBoxWindow;
      
      private var var_1690:IWindowContainer;
      
      private var var_1312:IWindowContainer;
      
      private var var_1071:IWindowContainer;
      
      private var var_1068:IWindowContainer;
      
      private var var_1692:IWindowContainer;
      ...
      {
         this.var_320 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_320));
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1691 = true;
         this.var_370.roomSettingsRefreshNeeded();
      }
      
      public function onFlatControllerAdded(param1:int, param2:FlatControllerData) : void
      {
         if(param1 != this.var_320)
         {
            return;
         }
      ...
      {
         if(param1 != this.var_320 || this.var_1067 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1067 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1287)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1426)
         {
            this.var_1064.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1330)
         {
            this.setTagError(this.var_861,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_860,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1275)
         {
            this.setTagError(this.var_861,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_860,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1390)
         {
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1064.clearErrors();
         this.var_861.clearErrors();
         this.var_860.clearErrors();
         this.var_859.clearErrors();
         this.var_1066.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_645,this.onDoorModePasswordUnselect);
         ...
         this.var_1064 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_861 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_860 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_859 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1066 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1070 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1065 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1072 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_578 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1690 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1312 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1071 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1068 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1692 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1313 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_234 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1069 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2368 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2369 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1689 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1689.procedure = this.onSwitchView;
         this.var_1069.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1690.visible = this._inRoom;
         this.var_1692.visible = this._inRoom;
         this.var_2369.visible = this.var_468;
         this.var_2368.visible = !this.var_468;
         if(this.var_468)
         {
            this.var_1068.visible = true;
            this.var_1313.visible = false;
            this.refreshFlatControllers();
            this.var_1068.height = Util.getLowestPoint(this.var_1068) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1312.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1312.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1071.height = Util.getLowestPoint(this.var_1071) + 4;
         }
         this.var_1689.text = !!this.var_468 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1690.name,this.var_1312.name,this.var_1071.name,this.var_1068.name,this.var_1313.name,this.var_1692.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_1064.setText(_loc1_.description);
         this.var_859.setText("");
         this.var_1066.setText("");
         ...
         this.setTag(this.var_861,_loc1_.tags[0]);
         this.setTag(this.var_860,_loc1_.tags[1]);
         if(this.var_1070)
         {
            if(_loc1_.allowPets)
            {
               this.var_1070.select();
            }
            else
            {
               this.var_1070.unselect();
            }
         }
         if(this.var_1065)
         {
            ...
            {
               this.var_1065.select();
            }
            else
            {
               this.var_1065.unselect();
            }
         }
         if(this.var_1072)
         {
            ...
            {
               this.var_1072.select();
            }
            else
            {
               this.var_1072.unselect();
            }
         }
         if(this.var_578)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = this.var_1064.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_427;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_106)
         {
            _loc8_ = this.var_859.getText();
            _loc9_ = this.var_1066.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_859.clearErrors();
               this.var_1066.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1070.isSelected;
         _loc2_.allowFoodConsume = this.var_1065.isSelected;
         _loc2_.allowWalkThrough = this.var_1072.isSelected;
         _loc2_.hideWalls = this.var_578.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_861,_loc2_.tags);
         this.addTag(this.var_860,_loc2_.tags);
         this.clearErrors();
         this.var_1067 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_320);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_74.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_320]);
         _loc2_.show();
      }
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_154,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_234.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_234.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_234.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_234.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_234.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_234.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_234.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_234);
         this.var_234.findChildByName("ruler").visible = true;
         ...
         if(this.var_74.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_234,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_57,HabboWindowStyle.const_35,HabboWindowParam.const_59,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_320));
      }
