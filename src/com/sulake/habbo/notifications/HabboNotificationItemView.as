package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_476:int = 4;
      
      private static const name_1:int = 0;
      
      private static const const_410:int = 1;
      
      private static const const_851:int = 2;
      ...
      private var var_196:HabboNotificationItem;
      
      private var var_1729:Boolean = false;
      
      private var var_2371:Map;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1728 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1728 = 15;
         }
         this.var_1727 = this._window.height;
         this.var_700 = 4;
         this.var_701 = 0;
         this._state = name_1;
      ...
      {
         if(param1.badgeId != this.var_196.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_410:
               ...
               _loc2_ = Number(this.var_1085) / Number(this.var_376["time_fade_in"]);
               if(this.var_1085 > int(this.var_376["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_851:
               ...
               if(this.var_1328 > int(this.var_376["time_display"]) && !this.var_1729)
               {
                  this.startFadeOut();
               }
               break;
            case const_850:
               ...
               _loc3_ = 1 - Number(this.var_1086) / Number(this.var_376["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1086 > int(this.var_376["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1728;
         if(this._window.height < this.var_1727)
         {
            this._window.height = this.var_1727;
         }
      }
      ...
      {
         this.var_1086 = 0;
         this._state = const_850;
      }
      
      private function startDisplay() : void
      {
         this.var_1328 = 0;
         this._state = const_851;
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         if(this.var_376["position_horizontal_follow_toolbar"] == "HabboWindowManagerCom_habbo_window_alert_xml" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            if(this._toolbar.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_476;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_476;
            }
         }
         else if(this.var_376["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_476;
         }
         else
         ...
         if(this.var_376["position_vertical_follow_toolbar"] == "HabboWindowManagerCom_habbo_window_alert_xml" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            if(this._toolbar.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_700;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_700;
            }
         }
         else if(this.var_376["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_700;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_701;
      }
   }
}
