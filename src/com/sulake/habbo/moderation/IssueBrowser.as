package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1778:String = "my_issues";
      
      private const const_1777:String = "open_issues";
      
      private const const_1779:String = "picked_issues";
      ...
      private var var_301:IIssueBrowserView;
      
      private var var_1562:IIssueBrowserView;
      
      private var var_1560:IIssueBrowserView;
      
      private var var_1561:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_223 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_223.numTabItems)
            {
               _loc5_ = this.var_223.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_62,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_223 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_223 == null || this.var_223.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_223.selector.getSelectableByName("open_issues");
         this.var_223.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_301 == _loc2_)
         {
            return;
         }
         if(this.var_301 != null)
         {
            this.var_301.visible = false;
         }
         this.var_301 = _loc2_;
         if(this.var_301 == null)
         {
         ...
         this.var_301.view.width = this.var_223.container.width;
         this.var_301.view.height = this.var_223.container.height;
         this.var_301.visible = true;
         this.var_301.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1778:
               if(this.var_1562 == null)
               {
                  this.var_1562 = new MyIssuesView(this.issueManager,this,this.var_223.container);
               }
               return this.var_1562;
            case this.const_1777:
               if(this.var_1560 == null)
               {
                  this.var_1560 = new OpenIssuesView(this.issueManager,this,this.var_223.container);
               }
               return this.var_1560;
            case this.const_1779:
               if(this.var_1561 == null)
               {
                  this.var_1561 = new PickedIssuesView(this.issueManager,this,this.var_223.container);
               }
