package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1062:IDropMenuWindow;
      
      private var var_411:ITextFieldWindow;
      
      private var var_596:Boolean = true;
      
      private var var_899:ICheckBoxWindow;
      
      private var var_1364:ICheckBoxWindow;
      
      private var var_1365:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_46.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_320));
         Logger.log("BEGINNING TO SHOW: " + this.var_320);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_320);
         if(param1.flatId != this.var_320)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_320);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      {
         this.var_52 = IItemListWindow(this._frame.findChildByName("list_cont"));
         ...
         this.var_1062 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1062);
         this.var_1062.procedure = this.onSelectTemplate;
         this.var_899 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1364 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1365 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_52.getListItemByName(param2));
         ...
         if(!param1.exists)
         {
            this.var_52.removeListItem(_loc3_);
            this.var_52.removeListItem(this.var_52.getListItemByName("event_spacing"));
            return;
         }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_46,WindowTracker.const_783,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_899.isSelected);
         this.var_46.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1377,_loc2_,this.var_411.text,"",""));
         if(this.var_1364.isSelected || this.var_1365.isSelected || this.var_899.isSelected)
         {
            this.var_46.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1364.isSelected,this.var_1365.isSelected,this.var_899.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1465);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1422);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_46.initMsg.roomMessageTemplates[this.var_1062.selection];
         if(_loc3_ != null)
         {
            this.var_596 = false;
            this.var_411.text = _loc3_;
         }
      }
   }
}
