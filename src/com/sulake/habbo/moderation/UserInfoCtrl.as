package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_866:int = 60;
      
      private static const const_865:int = 3600;
      
      private static const const_864:int = 86400;
      
      private static const const_863:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_866) + " mins ago";
         }
         if(param1 < 2 * const_864)
         {
            return Math.round(param1 / const_865) + " hours ago";
         }
         if(param1 < 2 * const_863)
         {
            return Math.round(param1 / const_864) + " days ago";
         }
         return Math.round(param1 / const_863) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1114.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_46.getXmlWindow("user_info"));
            this.var_1114.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_46,WindowTracker.const_887,this._data.userId),this._callerFrame,this.var_1113,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new RoomVisitsCtrl(this.var_46,this._data.userId),this._callerFrame,this.var_1113,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new SendMsgsCtrl(this.var_46,this._data.userId,this._data.userName,this.var_1177),this._callerFrame,this.var_1113,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_46.windowTracker.show(new ModActionCtrl(this.var_46,this._data.userId,this._data.userName,this.var_1177),this._callerFrame,this.var_1113,false,true);
      }
