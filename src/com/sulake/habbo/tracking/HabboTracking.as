package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_813:uint = 11;
      ...
      private var var_175:IHabboFriendList;
      
      private var var_964:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_165:IHabboHelp;
      ...
      private var var_220:PerformanceTracker = null;
      
      private var var_525:FramerateTracker = null;
      
      private var var_219:LatencyTracker = null;
      
      private var var_524:LagWarningLogger = null;
      
      private var var_526:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_220 = new PerformanceTracker();
         this.var_525 = new FramerateTracker();
         this.var_219 = new LatencyTracker();
         this.var_524 = new LagWarningLogger();
         this.var_526 = new ToolbarClickTracker(this);
         this.var_1205 = new Array(const_813);
         var _loc4_:int = 0;
         while(_loc4_ < const_813)
         {
            this.var_1205[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1433,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1317,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1442,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_713,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_940,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_964)
            {
               this.var_964.release(new IIDHabboWindowManager());
               this.var_964 = null;
            }
            if(this.var_274)
            {
            ...
            if(this.var_175)
            {
               if(!this.var_175.disposed)
               {
                  Component(this.var_175).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_175).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_175).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_175).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_175).events.removeEventListener(HabboFriendListTrackingEvent.const_375,this.onFriendlistTrackingEvent);
               }
               this.var_175.release(new IIDHabboFriendList());
               this.var_175 = null;
            }
            if(this.var_165)
            {
               if(!this.var_165.disposed)
               {
                  this.var_165.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_165.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_165.release(new IIDHabboHelp());
               this.var_165 = null;
            }
            if(this._toolbar)
            {
      ...
      {
         this.var_1205[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_152 = IHabboConfigurationManager(param2);
         if(this.var_152)
         {
            if(this.var_219 != null)
            {
               this.var_219.configuration = this.var_152;
            }
            if(this.var_220 != null)
            {
               this.var_220.configuration = this.var_152;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1483);
            if(this.var_152)
            {
               if(this.var_524 != null)
               {
                  this.var_524.configure(this.var_152);
               }
               if(this.var_525 != null)
               {
                  this.var_525.configure(this.var_152);
               }
               if(this.var_526 != null)
               {
                  this.var_526.configure(this.var_152);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_297);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_628,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_204,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_159,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_167,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_798,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_67,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_471,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_220 != null)
            {
               this.var_220.connection = param1;
            }
            if(this.var_219 != null)
            {
               this.var_219.communication = this._communication;
               this.var_219.connection = param1;
            }
            if(this.var_524 != null)
            {
               this.var_524.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_798)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1312);
         }
         else if(param1.type == HabboHotelViewEvent.const_471)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1445);
         }
         else if(param1.type == HabboHotelViewEvent.const_67)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1246);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1326);
               break;
            case HabboCommunicationEvent.const_628:
               this.trackLoginStep(HabboLoginTrackingStep.const_1237,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_204:
               this.trackLoginStep(HabboLoginTrackingStep.const_204);
               break;
            case HabboCommunicationEvent.const_167:
               this.trackLoginStep(HabboLoginTrackingStep.const_167);
               break;
            case HabboCommunicationEvent.const_159:
               this.setErrorContextFlag(2,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_159);
               break;
      ...
      {
         this.var_964 = IHabboWindowManager(param2);
         if(this.var_964)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_152)
            {
               if(this.var_152.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_152.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1205)
                  {
                  ...
                  if(this.var_220 != null)
                  {
                     _loc4_["null"] = this.var_220.flashVersion;
                     _loc4_["null"] = this.var_220.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_965);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_965,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_175 = param2 as IHabboFriendList;
         Component(this.var_175).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_175).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_175).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_175).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_175).events.addEventListener(HabboFriendListTrackingEvent.const_375,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_375:
      ...
      {
         this.var_165 = param2 as IHabboHelp;
         this.var_165.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_165.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2043)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1324);
            this.var_2043 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_940,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_713,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_261,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_274 = param2 as IAdManager;
         this.var_274.events.addEventListener(AdEvent.const_489,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_526)
         {
            this.var_526.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_152 != null && !Boolean(this.var_152.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_524.chatLagDetected();
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_963 > -1 && _loc2_ < this.var_963)
         {
            ++this.var_1497;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1497);
         }
         if(this.var_963 > -1 && _loc2_ - this.var_963 > 15000)
         {
            ++this.var_1498;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1498);
         }
         this.var_963 = _loc2_;
         if(this.var_220 != null)
         {
            this.var_220.update(param1);
         }
         if(this.var_219 != null)
         {
            this.var_219.update(param1);
         }
         if(this.var_525 != null)
         {
            this.var_525.trackUpdate(param1,this);
         }
         if(this.var_524 != null)
         {
            this.var_524.update();
