package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_956:Function;
      
      private var var_955:Function;
      
      private var var_639:IAssetLibrary;
      
      private var var_954:uint = 0;
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_639.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_30,this.hotelViewLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_44,this.hotelViewLoadedHandler);
         }
         else
         {
            this.var_955 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_30,this.hotelViewLoadedCallbackHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_44,this.hotelViewLoadedCallbackHandler);
         }
         ++this.var_954;
      }
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_639.getAssetByName(_loc2_.assetName);
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_44,this.hotelViewLoadedHandler);
      }
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_30)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_471));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this._window && !this._window.disposed)
            {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_44,this.hotelViewLoadedCallbackHandler);
      }
      
      public function loadBannerImage(param1:String, param2:Function) : void
      {
         var _loc3_:AssetLoaderStruct = this.var_639.loadAssetFromFile("hotel_view_banner_" + this.var_954,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
            _loc3_.addEventListener(AssetLoaderEvent.const_30,this.bannerLoadedHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_44,this.bannerLoadedHandler);
         }
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_798));
            }
            this.var_956 = param2;
            _loc3_.addEventListener(AssetLoaderEvent.const_30,this.bannerLoadedCallbackHandler);
            _loc3_.addEventListener(AssetLoaderEvent.const_44,this.bannerLoadedCallbackHandler);
         }
         ++this.var_954;
      }
      ...
      private function bannerLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_44,this.bannerLoadedHandler);
      }
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         _loc2_.removeEventListener(AssetLoaderEvent.const_44,this.bannerLoadedCallbackHandler);
      }
