package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1111:String = "asset-libraries";
      
      private static const const_1109:String = "library";
      
      private static const const_1110:String = "service-libraries";
      
      private static const const_1107:String = "library";
      
      private static const const_1108:String = "component-libraries";
      
      private static const const_1112:String = "library";
       
      
      private var var_290:LibraryLoaderQueue;
      
      private var var_215:Profiler;
      
      private var var_623:IEventDispatcher;
      
      private var var_409:uint;
      
      private var var_410:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         {
            this.var_408.push(new Array());
            this.var_513.push(0);
            _loc3_++;
         }
         this.var_1429 = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_401.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1032:
               debug("Core; using simple frame update handler");
               this.var_410 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_779:
               debug("Core; using complex frame update handler");
               this.var_410 = this.complexFrameUpdateHandler;
               break;
            case Core.const_1418:
               debug("Core; using profiler frame update handler");
               this.var_410 = this.profilerFrameUpdateHandler;
               this.var_215 = new Profiler(this);
               attachComponent(this.var_215,[new IIDProfiler()]);
               var_401.addChild(new ProfilerViewer(this.var_215));
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_410 = this.debugFrameUpdateHandler;
         }
      }
      ...
      {
         return this.var_409 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            var_401.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
            var_401 = null;
            _loc3_ = 0;
            while(_loc3_ < CoreComponentContext.const_141)
            {
               _loc2_ = this.var_408[_loc3_] as Array;
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_623 = loadingEventDelegate;
         if(this.var_290 == null)
         {
            this.var_290 = new LibraryLoaderQueue(var_612);
         }
         try
         {
            ...
            if(node != null)
            {
               list = node.child(const_1109);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,var_612);
                  assets.loadFromFile(loader,true);
                  loader.load(new URLRequest(url));
                  this.var_290.push(loader);
         ...
         try
         {
            node = config.child(const_1110)[0];
            if(node != null)
            {
               list = node.child(const_1107);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,var_612);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1259);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_623)
         {
            this.var_623.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_623)
         {
            ...
            this.var_623.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
      ...
      private function updateLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(this.var_623)
               {
                  this.var_623.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_409 - this.var_290.length,this.var_409,_loc2_.elapsedTime));
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = this.var_408[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = this.var_408[_loc4_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_410(_loc2_,_loc2_ - this.var_1429);
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         {
            this.var_513[criticality] = 0;
            receivers = this.var_408[criticality];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_401.stage.frameRate;
         criticality = 0;
         while(criticality < CoreComponentContext.const_141)
         {
            t = getTimer();
            ...
            {
               if(this.var_513[criticality] < criticality)
               {
                  ++this.var_513[criticality];
                  skip = true;
               }
            }
            if(!skip)
      ...
      private function debugFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(_loc3_ < CoreComponentContext.const_141)
         {
            this.var_513[_loc3_] = 0;
            _loc4_ = this.var_408[_loc3_];
            _loc7_ = 0;
