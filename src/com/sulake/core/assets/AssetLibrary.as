package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_960:String = "AssetLibraryReady";
      
      public static const const_795:String = "AssetLibraryLoaded";
      
      public static const const_1472:String = "AssetLibraryUnloaded";
      
      public static const const_1243:String = "AssetLibraryLoadError";
      
      private static var var_265:Dictionary;
      
      private static var _lazyAssetProcessor:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_436:uint = 0;
      
      private static var var_811:Array = new Array();
      ...
      private var var_662:XML;
      
      private var var_810:Boolean;
      
      private var var_359:uint;
      
      private var var_38:LibraryLoader;
      
      private var var_546:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         super();
         this._name = param1;
         this.var_662 = new XML();
         this.var_359 = 0;
         this.var_360 = new Array();
         if(var_265 == null)
         {
            var_265 = new Dictionary(false);
         ...
         ++var_436;
         this.var_358 = new Dictionary(false);
         this.var_435 = new Dictionary(false);
         this.var_808 = new Dictionary(false);
         this.var_137 = new Dictionary(false);
         var_811.push(this);
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_811.splice(var_811.indexOf(this),1);
            --var_436;
            this.var_435 = null;
            this.var_808 = null;
            this.var_137 = null;
      ...
      {
         if(this._file == param1.url && this.var_810)
         {
            if(!this.var_809 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_662,this.var_546);
            }
            this.var_809 = param2;
         ...
         {
            if(this.var_38 == null || this.var_38.disposed)
            {
               this.var_38 = param1;
               this.var_38.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.libraryLoadedHandler);
               this.var_38.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.loadErrorHandler);
            }
            this.var_809 = param2;
            this._file = this.var_38.url;
         }
      }
      ...
      public function unload() : void
      {
         ...
         {
            _loc2_ = this.var_435[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_435[_loc1_];
         }
         for(_loc1_ in this.var_137)
         {
            delete this.var_137[_loc1_];
         }
         for(_loc1_ in this.var_808)
         {
            delete this.var_808[_loc1_];
         }
         if(this.var_38 != null)
         {
            this.var_38.dispose();
         ...
         this.var_810 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1472));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_808[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         if(this.var_38 != null)
         {
            if(this.var_38.hasDefinition(param1))
            {
               _loc2_ = this.var_38.getDefinition(param1) as Class;
               if(_loc2_ != null)
               {
                  this.var_808[param1] = _loc2_;
                  return _loc2_;
               }
            }
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_435[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_44,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_948,this.assetLoadEventHandler);
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1067,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_435[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_435[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_30:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_137[struct.assetName] == null)
                  {
                     ++this.var_359;
                     this.var_360.push(struct.assetName);
                  }
                  this.var_137[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_44,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_435[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_137[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_360.length ? this.getAssetByName(this.var_360[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_137)
         {
            if(this.var_137[_loc2_] == param1)
            {
               return this.var_360.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_137[param1] != null || (this.var_546 != null ? this.var_546[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_137[param1] == null;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_265.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_265[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_358.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_358[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_265[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         _loc3_ = AssetTypeDeclaration(this.var_358[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_265)
            {
               _loc3_ = AssetTypeDeclaration(var_265[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_358)
         {
            _loc3_ = AssetTypeDeclaration(this.var_358[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_265)
            {
               _loc4_ = AssetTypeDeclaration(var_265[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_358)
         {
            _loc4_ = AssetTypeDeclaration(this.var_358[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_662 = _loc2_.manifest.copy();
         this.var_546 = _loc2_.resource;
         ...
         this.var_810 = true;
         dispatchEvent(new Event(AssetLibrary.const_795));
         dispatchEvent(new Event(AssetLibrary.const_960));
         if(this.var_809)
         {
            this.var_38.removeEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,this.libraryLoadedHandler);
            this.var_38.removeEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,this.loadErrorHandler);
            this.var_38.addEventListener(LibraryLoader.LIBRARY_LOADER_FINALIZE,this.finalizeLoaderEventHandler);
            this.var_38 = null;
            this.var_546 = null;
         }
      }
      ...
      {
         this.var_810 = false;
         Logger.log("Cannot load the specified file:" + this._file);
         dispatchEvent(new Event(AssetLibrary.const_1243));
         this.var_38 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_662.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_546[param1]);
