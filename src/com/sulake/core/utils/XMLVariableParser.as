package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1319:String = "float";
      
      public static const const_48:String = "Boolean";
      
      public static const const_1346:String = "bool";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_243 || _loc5_ == const_150)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1319:
               return Number(param1);
            case const_48:
               return param1 == "HabboWindowManagerCom_habbo_window_alert_xml" || int(param1) > 0;
            case const_1346:
               return param1 == "HabboWindowManagerCom_habbo_window_alert_xml" || int(param1) > 0;
            case const_161:
               return uint(param1);
