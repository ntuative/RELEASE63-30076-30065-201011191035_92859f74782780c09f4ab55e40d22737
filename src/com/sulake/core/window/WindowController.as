package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected var var_750:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_339 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_56 = var_339.clone();
            var_11 = var_339.clone();
         ...
         if(_loc13_)
         {
            var_701 = _loc13_.blend;
            var_396 = _loc13_.treshold;
            if(var_491 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_397 != _loc13_.color)
            {
      ...
      {
         return this.var_750 != null ? this.var_750 : (this.var_13 != null ? this.var_13.procedure : this.nullEventProc);
      }
      ...
      {
         var_491 = param1;
         var_397 = !!var_491 ? uint(var_397 | var_1142) : uint(var_397 & 16777215);
         this.var_148 = this.var_148 || param1;
         var_17.invalidate(this,var_11,WindowRedrawFlag.const_79);
      }
      ...
      {
         var_740 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_450,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_1142 = param1 & 4278190080;
         var_397 = !!var_491 ? uint(param1) : uint(param1 & 16777215);
         var_17.invalidate(this,var_11,WindowRedrawFlag.const_79);
      }
      
      public function set blend(param1:Number) : void
      {
         var_701 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_17.invalidate(this,var_11,WindowRedrawFlag.const_926);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_393,this,null));
         }
      }
      ...
      {
         var_396 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_324 = this.var_13.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
               var_56.width = var_11.width;
               var_56.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_512,this,this.var_13));
            }
            else
            {
               this.var_324.x = 0;
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_878,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_76,_param,var_17,var_11,null,this.var_750,this.properties,var_741.concat(),_id) as WindowController;
         _loc2_.var_396 = var_396;
         _loc2_.var_148 = this.var_148;
         _loc2_.var_612 = this.var_612;
         _loc2_.var_324 = this.var_324.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_339 = var_339.clone();
         _loc2_.var_56 = var_56.clone();
         _loc2_.var_125 = !!var_125 ? var_125.clone() : null;
         _loc2_.var_126 = !!var_126 ? var_126.clone() : null;
         _loc2_.var_70 = !!var_70 ? var_70.clone(_loc2_) : null;
         _loc2_.var_17 = var_17;
         _loc2_.var_397 = var_397;
         _loc2_.var_1142 = var_1142;
         _loc2_.var_740 = var_740;
         _loc2_.var_338 = var_338;
         _loc2_.var_701 = var_701;
         _loc2_._param = _param;
         _loc2_._state = _state;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_97;
         _loc2_.background = var_491;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2404 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_17.invalidate(this,param1,WindowRedrawFlag.const_79);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_453)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_391)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(_param & 0);
            if(_loc7_ == WindowParam.const_500)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_994,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_592,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_434,this,null));
            }
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_173,this,null));
            }
         }
      }
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_125 != null)
         {
            param3.x = var_125.x;
            param3.y = var_125.y;
            param3.width = var_125.width;
            param3.height = var_125.height;
         }
         if(param4 != null && var_126 != null)
         {
            param4.x = var_126.x;
            param4.y = var_126.y;
            param4.width = var_126.width;
            param4.height = var_126.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            if(var_126 == null)
            {
               var_126 = new Rectangle();
            }
            var_126.x = param3.x;
            var_126.y = param3.y;
            var_126.width = param3.width;
            var_126.height = param3.height;
         }
         if(param2 != null)
         {
            ...
            if(var_125 == null)
            {
               var_125 = new Rectangle();
            }
            var_125.x = param2.x;
            var_125.y = param2.y;
            var_125.width = param2.width;
            var_125.height = param2.height;
         }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_747))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_40:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1088;
                  if(testParamFlag(WindowParam.const_311))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_242))
                        {
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_283))
                        {
               ...
               case WindowMouseEvent.const_58:
                  ...
                  if(testParamFlag(WindowParam.const_283))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_173:
                  var_17.invalidate(this,var_11.union(var_56),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_394,this,null));
                     if(testParamFlag(WindowParam.const_183,WindowParam.const_149))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_181,WindowParam.const_157))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this.var_13 != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_459))
                        {
               ...
               case WindowNotifyEvent.const_434:
                  var_17.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_484);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1074,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_304,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_314:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_724,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_207,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_393:
                  var_17.invalidate(this,var_11,WindowRedrawFlag.const_1002);
                  break;
               ...
               case WindowNotifyEvent.const_450:
                  if(!(_param & 0))
                  {
                     if(!this.var_20)
                     {
                        ...
                        var_17.invalidate(this,var_11,WindowRedrawFlag.const_484);
                     }
                  }
                  else if(_param & 0)
                  {
                  ...
                  break;
               case WindowNotifyEvent.const_512:
                  if(testParamFlag(WindowParam.const_183,WindowParam.const_149))
                  {
                     this.updateScaleRelativeToParent();
                  }
               ...
               case WindowNotifyEvent.const_394:
                  this.var_13.getRegionProperties(null,this.var_324);
                  this.updateScaleRelativeToParent();
                  break;
               ...
               case WindowNotifyEvent.const_304:
                  ...
                  break;
               case WindowNotifyEvent.const_610:
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1023:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1298:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1411:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_329:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_584:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_712:
               _loc2_ = "null";
               break;
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_396);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_396);
      }
         ...
         if(this.var_148 && var_396 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1324,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1324,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_117,WindowParam.const_149);
         var _loc2_:* = !testParamFlag(WindowParam.const_125,WindowParam.const_157);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_324.width;
               _loc5_ = uint(_param & 0);
               if(_loc5_ == WindowParam.WINDOW_PARAM_RELATIVE_HORIZONTAL_SCALE_STRECH)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_334)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_324.height;
               _loc5_ = uint(_param & 0);
               if(_loc5_ == WindowParam.const_342)
               {
      ...
      {
         if(_state == WindowState.const_495)
         {
            return true;
         }
         _state = WindowState.const_495;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_944,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_931;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1023;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_65,false);
         _loc1_.type = WindowNotifyEvent.const_875;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1049,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_672;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_685;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_920,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1323 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_343,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1323 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_610,this,param1));
         return param1;
      }
