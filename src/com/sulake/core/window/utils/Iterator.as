package com.sulake.core.window.utils
{
   ...
   public class Iterator extends Proxy implements IIterator
   {
      ...
      private static const const_1180:uint = 0;
      
      private static const const_190:uint = 1;
      ...
      private static const const_189:uint = 5;
      ...
      public function Iterator(param1:WindowController)
      {
         ...
         {
            this._type = Iterator.const_187;
         }
         else if(this.var_33 is ISelectorWindow)
         {
            this._type = Iterator.const_188;
         }
         ...
         {
            this._type = Iterator.const_1180;
         }
      }
