package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_170;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_77 = param1.var_1136 as WindowController;
         this._lastClickTarget = param1.var_1138 as WindowController;
         this.var_138 = param1.renderer;
         this.var_745 = param1.var_1137;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_611.x || _loc3_.stageY != this.var_611.y)
            {
               this.var_611.x = _loc3_.stageX;
               this.var_611.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_129.groupParameterFilteredChildrenUnderPoint(this.var_611,_loc6_,WindowParam.const_46);
            }
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_77 && !this.var_77.disposed)
                     {
                        ...
                        {
                           this.var_745.mouseEventReceived(_loc3_.type,this.var_77);
                        }
                     }
                  }
         ...
         param1.var_1136 = this.var_77;
         param1.var_1138 = this._lastClickTarget;
         param1.renderer = this.var_138;
         param1.var_1137 = this.var_745;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_138.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_521))
         {
