package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_1388:uint = 0;
      
      protected var var_249:Function;
      
      protected var var_1143:int;
      
      protected var var_1144:int;
      ...
      protected function operate(param1:TimerEvent) : void
      {
         this.var_1143 *= 0.75;
         this.var_1144 *= 0.75;
         if(Math.abs(this.var_1143) <= 1 && Math.abs(this.var_1144) <= 1)
         {
            this.end(this._window);
         }
         else if(this.var_249 != null)
         {
            this.var_249(this.var_1143,this.var_1144);
         }
      }
