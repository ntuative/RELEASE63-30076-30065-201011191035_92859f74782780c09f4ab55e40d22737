package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1172:String = "_TITLE";
      
      private static const const_1173:String = "_HEADER";
      
      private static const const_1175:String = "_CONTENT";
      
      private static const const_1174:String = "_SCALER";
      
      private static const const_827:String = "margin_left";
      
      private static const const_828:String = "margin_top";
      
      private static const const_830:String = "margin_right";
      
      private static const const_829:String = "margin_bottom";
       
      
      private var _title:ITextWindow;
      
      private var var_1266:IHeaderWindow;
      ...
      public function get title() : ITextWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1172) as ITextWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1266 = findChildByTag(const_1173) as IHeaderWindow;
            if(!this.var_1266)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_166 = findChildByTag(const_1175) as IWindowContainer;
            if(!this.var_166)
            {
      ...
      {
         return findChildByTag(const_1174) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1104,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1141 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_283);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_245);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_219);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_219,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_219,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_260,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_827,_loc3_.left,PropertyStruct.const_54,_loc2_));
         _loc1_.push(new PropertyStruct(const_828,_loc3_.top,PropertyStruct.const_54,_loc2_));
         _loc1_.push(new PropertyStruct(const_830,0 - _loc3_.right,PropertyStruct.const_54,_loc2_));
         _loc1_.push(new PropertyStruct(const_829,0 - _loc3_.bottom,PropertyStruct.const_54,_loc2_));
         return _loc1_;
      }
