package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1099:Dictionary = createPropertySetterTable();
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,param3,this.var_305);
      ...
      private static function setBold(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.var_305.fontWeight = TextStyle.BOLD;
      }
      ...
      private static function setFontFace(param1:TextController, param2:String) : void
      {
         ...
         param1.defaultTextFormat = _loc3_;
         param1.var_305.fontFamily = param2;
      }
      ...
      private static function setFontSize(param1:TextController, param2:uint) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_305.fontSize = param2;
      }
      ...
      private static function setHtmlText(param1:TextController, param2:String) : void
      {
         ...
         if(param1.var_497)
         {
            param1.context.removeLocalizationListener(param1.var_97,param1);
            param1.var_497 = false;
         }
         param1.var_97 = param2;
         if(param1.var_97.charAt(0) == "$" && param1.var_97.charAt(1) == "{")
         {
            param1.context.registerLocalizationListener(param1.var_97.slice(2,param1.var_97.indexOf("}")),param1);
            param1.var_497 = true;
         }
         else if(param1._field != null)
         {
            param1._field.htmlText = param1.var_97;
            param1.refreshTextImage();
         }
      }
      ...
      private static function setItalic(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_305.fontStyle = !!param2 ? "null" : TextStyle.NORMAL;
      }
      ...
      private static function setSpacing(param1:TextController, param2:Number) : void
      {
         ...
         param1.setTextFormat(_loc4_);
         param1.defaultTextFormat = _loc3_;
         param1.var_305.letterSpacing = param2;
      }
      ...
      private static function setUnderline(param1:TextController, param2:Boolean) : void
      {
         ...
         param1.setTextFormat(new TextFormat(_loc3_.font,_loc3_.size,_loc3_.color,_loc3_.bold,_loc3_.italic,_loc3_.underline,_loc3_.url,_loc3_.target,_loc3_.align,_loc3_.leftMargin,_loc3_.rightMargin,_loc3_.indent,_loc3_.leading));
         param1.defaultTextFormat = _loc3_;
         param1.var_305.textDecoration = !!param2 ? "null" : TextStyle.NONE;
      }
      ...
      {
         this.var_746 = param1;
         this._field.scrollH = this.var_746 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_746 * this.maxScrollH,this.var_496 * this.maxScrollV,width,height);
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         if(this.var_497)
         {
            context.removeLocalizationListener(var_97,this);
            this.var_497 = false;
         }
         var_97 = param1;
         if(var_97.charAt(0) == "$" && var_97.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_97.slice(2,var_97.indexOf("}")),this);
            this.var_497 = true;
         }
         else if(this._field != null)
         {
            this._field.text = var_97;
            this.refreshTextImage();
         }
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_746 = this.var_746;
         _loc1_.var_496 = this.var_496;
      ...
      {
         setTextFormatting(this._field,style,this.var_305);
         this.refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_161,this._field.textColor != _loc2_.color));
         ...
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_161,this._field.borderColor != 0));
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_230,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("style_sheet",this._field.styleSheet,PropertyStruct.const_91,this._field.styleSheet != null));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_230,this._field.thickness != 0));
         _loc1_.push(new PropertyStruct("word_wrap",this._field.wordWrap,PropertyStruct.const_48,this._field.wordWrap != false));
         _loc1_.push(new PropertyStruct("margin_left",this.var_78.left,PropertyStruct.const_54,this.var_78.left != 0));
         _loc1_.push(new PropertyStruct("margin_top",this.var_78.top,PropertyStruct.const_54,this.var_78.top != 0));
         _loc1_.push(new PropertyStruct("margin_right",this.var_78.right,PropertyStruct.const_54,this.var_78.right != 0));
         _loc1_.push(new PropertyStruct("margin_bottom",this.var_78.bottom,PropertyStruct.const_54,this.var_78.bottom != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_230,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
