package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_379:String = "_DROPMENU_TITLETEXT";
      
      protected static const const_1103:String = "_DROPMENU_ITEMLIST";
      
      protected static const const_1102:String = "item_array";
      ...
      private var var_162:DropMenuController;
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_462,this,null,true);
      ...
      {
         if(this.var_162 != null && !this.var_162.disposed)
         {
            this.var_162.destroy();
            this.var_162 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_379) as ITextWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_162 == null || this.var_162.disposed)
         {
            this.var_162 = context.create(name + "::submenu","",WindowType.const_519,var_76,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_162.setGlobalRectangle(_loc1_);
         }
         this.var_162.activate();
         return this.var_162;
      }
      ...
      {
         var _loc2_:int = -1;
         var _loc3_:IItemListWindow = getChildByName(DropMenuController.const_1103) as IItemListWindow;
         if(_loc3_ != null)
         {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_162.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_844 = false;
            this.getTitleText().text = this.var_571 < this._itemArray.length && this.var_571 > -1 ? this._itemArray[this.var_571] : caption;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IItemListWindow = param2.getChildByName(DropMenuController.const_1103) as IItemListWindow;
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_523,var_76,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_360,var_76,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_571 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_571).setStateFlag(WindowState.const_52,true);
         }
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1082:
            case WindowMouseEvent.const_58:
               ...
               break;
            case WindowTouchEvent.const_623:
            case WindowMouseEvent.const_40:
               ...
               break;
            case WindowEvent.const_1033:
               if(param2 == this.var_162)
               {
                  this.closeMenuView();
               }
         }
      ...
      public function close() : Boolean
      {
         ...
         visible = false;
         _loc1_.type = WindowNotifyEvent.const_1059;
         this.update(this,_loc1_);
         return true;
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1102,this._itemArray,PropertyStruct.const_150,this._itemArray.length > 0));
         return _loc1_;
      }
