package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1156 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_20)
         {
            var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.GC_TYPE_TEXTFIELD,var_11);
         }
         return var_20;
      }
      ...
      {
         var_17.getWindowServices().getFocusManagerService().removeFocusWindow(this);
         this.var_1151 = false;
         if(_field)
         {
            if(this.focused)
      ...
      {
         if(param1.type == WindowTouchEvent.const_467)
         {
            this.focus();
         }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_17.handleError(WindowContext.const_362,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",this.var_1151,PropertyStruct.const_48,this.var_1151 != false));
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(_loc2_.key == "focus_capturer")
            {
               ...
               if(this.var_1151)
               {
                  var_17.getWindowServices().getFocusManagerService().registerFocusWindow(this);
               }
               break;
            }
         }
