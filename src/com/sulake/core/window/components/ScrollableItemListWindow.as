package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1132:IItemListWindow;
      
      private var var_393:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_393)
         {
            this.var_393.removeEventListener(WindowEvent.const_305,this.scrollBarEventProc);
            this.var_393.removeEventListener(WindowEvent.const_223,this.scrollBarEventProc);
            this.var_393 = null;
         }
         if(this.var_1132)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1132)
         {
            this.var_1132 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_393)
         {
            this.var_393 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_393)
            {
               this.var_393.addEventListener(WindowEvent.const_305,this.scrollBarEventProc);
               this.var_393.addEventListener(WindowEvent.const_223,this.scrollBarEventProc);
            }
         }
         return this.var_393;
      }
      ...
      {
         if(param1.type == WindowEvent.const_305)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_223)
         {
            this.hideScrollBar();
         }
      }
