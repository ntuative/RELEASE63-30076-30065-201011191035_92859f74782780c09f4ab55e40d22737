package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1754:uint = 64;
      
      public static const const_1599:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_501:uint = 0;
      
      protected static var var_283:uint = 0;
       
      
      protected var _childSpriteContainer:DisplayObjectContainer;
      
      protected var var_1858:Boolean;
      
      protected var var_749:Boolean;
      
      protected var _disposed:Boolean = false;
      
      protected var var_11:Rectangle;
      
      protected var var_170:Shape;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_170)
            {
               this.var_170 = new Shape();
               this.var_170.visible = false;
               this.var_170.cacheAsBitmap = true;
               super.addChild(this.var_170);
            }
            this.var_170.graphics.clear();
            this.var_170.graphics.beginFill(255);
            this.var_170.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_170.graphics.endFill();
            this.getDisplayObject().mask = this.var_170;
         }
         else if(this.var_170)
         {
            super.removeChild(this.var_170);
            this.var_170.graphics.clear();
            this.var_170 = null;
         ...
         if(this.var_749)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_283 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1858,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1858,16777215);
                  }
                  var_283 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_749)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_283 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
