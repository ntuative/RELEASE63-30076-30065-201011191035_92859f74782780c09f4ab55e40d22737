package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_824:uint = 8;
      
      private static const const_1158:String = "skin";
      
      private static const const_1162:String = "bitmap";
      
      private static const const_1156:String = "fill";
      
      private static const const_1159:String = "text";
      
      private static const const_1161:String = "shape";
      
      private static const const_1160:String = "unknown";
      
      private static const const_1157:String = "null";
      ...
      private var var_2209:Dictionary;
      
      private var var_2207:Dictionary;
      
      private var var_2208:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2209 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1582,this.var_2209);
         this.var_2207 = new Dictionary();
         this.var_2208 = new Dictionary();
         StateCodeTable.fillTables(this.var_2207,this.var_2208);
         this.var_434 = new Dictionary();
         this.var_434[const_1158] = BitmapSkinRenderer;
         this.var_434[const_1162] = BitmapDataRenderer;
         this.var_434[const_1156] = FillSkinRenderer;
         this.var_434[const_1159] = TextSkinRenderer;
         this.var_434[const_1161] = ShapeSkinRenderer;
         this.var_434[const_1160] = SkinRenderer;
         this.var_434[const_1157] = NullSkinRenderer;
         if(var_282 == null)
         {
            var_282 = new Array();
            var_282.push(WindowState.const_65);
            var_282.push(WindowState.const_75);
            var_282.push(WindowState.const_83);
            var_282.push(WindowState.const_52);
            var_282.push(WindowState.WINDOW_STATE_HOVERING);
            var_282.push(WindowState.const_77);
            var_282.push(WindowState.const_97);
            var_282.push(WindowState.const_94);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.background = !!_loc5_.@background[0] ? _loc5_.@background[0] == "HabboWindowManagerCom_habbo_window_alert_xml" : false;
                  ...
                  this.addSkinRenderer(this.var_1582[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_804[param1] == null)
         {
            this.var_804[param1] = new Array(const_824);
         }
         this.var_804[param1][param2] = param3;
         if(this.var_805[param1] == null)
         {
            this.var_805[param1] = new Array(const_824);
         }
         this.var_805[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_804[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_295)
            {
               _loc4_ = _loc3_["null"];
            }
         }
