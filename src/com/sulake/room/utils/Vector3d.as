package com.sulake.room.utils
{
   public class Vector3d implements IVector3d
   {
      ...
      public function get length() : Number
      {
         ...
         {
            this._length = Math.sqrt(this._x * this._x + this.var_155 * this.var_155 + this.var_156 * this.var_156);
         }
         return this._length;
      }
      ...
      public function add(param1:IVector3d) : void
      {
         ...
         this._x += param1.x;
         this.var_155 += param1.y;
         this.var_156 += param1.z;
         this._length = NaN;
      }
