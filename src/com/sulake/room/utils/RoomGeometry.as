package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_733:Number = 64;
      
      public static const const_1041:Number = 32;
      ...
      private var var_390:Number = 1.0;
      ...
      private var var_2626:Number = -500.0;
      
      private var var_2625:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1130 = new Vector3d();
         this.var_1809 = 1;
         this.var_1810 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1808 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_156.x,this.var_156.y,this.var_156.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_75.x * this.var_392,this.var_75.y * this.var_390,this.var_75.z * this.var_391);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_246.x,this.var_246.y,this.var_246.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_392 != param1 * this.var_1809)
         {
            this.var_392 = param1 * this.var_1809;
            ++this.var_147;
         }
      }
      ...
      {
         if(this.var_390 != param1 * this.var_1810)
         {
            this.var_390 = param1 * this.var_1810;
            ++this.var_147;
         }
      }
      ...
      {
         if(this.var_391 != param1 * this.var_1808)
         {
            this.var_391 = param1 * this.var_1808;
            ++this.var_147;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_75.x /= this.var_392;
         this.var_75.y /= this.var_390;
         this.var_75.z /= this.var_391;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_246.x;
         var _loc3_:Number = this.var_246.y;
         var _loc4_:Number = this.var_246.z;
         this.var_246.assign(param1);
         if(this.var_246.x != _loc2_ || this.var_246.y != _loc3_ || this.var_246.z != _loc4_)
         {
            ++this.var_147;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_155.assign(_loc24_);
            this.var_156.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_155.assign(_loc19_);
            this.var_156.assign(_loc20_);
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_484 != null)
         {
            ...
            this.var_484.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_484.add(_loc3_,_loc4_);
            ++this.var_147;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_484 != null)
         {
            ...
            return this.var_484.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1130.assign(_loc22_);
         }
         else
         {
            this.var_1130.assign(_loc17_);
         }
         ++this.var_147;
      }
      ...
      {
         if(param1 == null || this.var_156 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(this.var_156,-param2);
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_155);
         var _loc4_:Number = Vector3d.scalarProjection(param1,this.var_156);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_390;
         _loc2_.z *= this.var_391;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1130);
         if(_loc3_ < this.var_2626 || _loc3_ > this.var_2625)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_155);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_390;
            _loc2_.z *= this.var_391;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1130);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_155,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_75.x * this.var_392,this.var_75.y * this.var_390,this.var_75.z * this.var_391);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_156;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_392,param2.y * this.var_390,param2.z * this.var_391);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_392,param3.y * this.var_390,param3.z * this.var_391);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_392,param4.y * this.var_390,param4.z * this.var_391);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1041;
         }
         else
         {
            this.scale = const_733;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_733;
      }
