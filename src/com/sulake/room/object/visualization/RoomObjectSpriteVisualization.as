package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_293:IRoomObject;
      
      private var var_1180:IGraphicAssetCollection;
      
      protected var var_403:int = -1;
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_183.length > 0)
            {
               _loc1_ = this.var_183[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(this.var_183.length > param1)
         {
            _loc2_ = this.var_183[this.var_183.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_183.length)
         {
      ...
      {
         this.var_403 = 4294967295;
         this.var_212 = 4294967295;
         this.var_251 = -1;
      }
