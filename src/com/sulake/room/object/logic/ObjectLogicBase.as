package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_293:IRoomObjectController;
      ...
      {
         if(this.var_293 == param1)
         {
            return;
         }
         if(this.var_293 != null)
         {
            this.var_293.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_293 = param1;
            this.var_293.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_293 != null)
            {
               this.var_293.setLocation(param1.loc);
               this.var_293.setDirection(param1.dir);
            }
         }
      }
   }
